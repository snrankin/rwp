...
module.exports = {
	// Project Identity
	appName: 'riesterWpCore', // Unique name of your project
	type: 'plugin', // Plugin or theme
	slug: 'rwp', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'riesterWpCore',
		author: 'RIESTER Advertising Agency (wordpress@riester.com) <https://www.riester.com>',
		license: 'GPL-2.0-or-later',
		link: 'GPL-2.0-or-later',
		version: pkg.version,
		copyrightText: 'This software is released under the GPL-2.0-or-later License\nhttps://opensource.org/licenses/GPL-2.0-or-later',
		credit: true,
	},
	...
	files: [
		// If this has length === 1, then single compiler
		{
			...
			entry: {
				...
				modal: ['./src/js/plugins/modal.js', './src/js/plugins/modal.scss'],
			},
	...
	packageFiles: ['includes/**', 'dependencies/**', 'assets/**', 'rwp.php', 'readme.txt', 'uninstall.php', 'config.json'],

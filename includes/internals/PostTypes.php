...
class PostTypes extends Singleton {
	...
	public function initialize() {
		...
		$cpts = $cpts->mapWithKeys(function ($item, $key) {
	...
	public function init_team_member_cpt(){
		...
		\add_filter( 'rwp_team_member_cpt_args', function($args) {
			$updated_args = array(
	...
	public function init_global_block_cpt(){
		...
		\add_filter( 'rwp_global_block_cpt_args', function($args) {
			$updated_args = array(
	...
	public function init_page_header_cpt(){
		...
		\add_filter( 'rwp_page_header_cpt_args', function($args) {
			$updated_args = array(
	...
	public function init_landing_page_cpt(){
		\add_filter( 'rwp_landing_page_cpt_args', function($args) {
			$updated_args = array(

 ...
 * @return string
 */
function gravity_forms_string_filter( $string ) {
...
function input_to_button( $button, $form ) {
	...
	$button = gravity_forms_string_filter( $button );
...
rwp_add_filters(array(
	...
	'gform_submit_button',
), __NAMESPACE__ . '\\input_to_button', 30, 2);
...
function field_content( $field_content, $field, $value, $entry_id, $form_id ) {
	...
	$field_input = gravity_forms_string_filter( $field_input );

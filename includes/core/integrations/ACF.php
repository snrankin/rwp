...
class ACF extends Singleton {
	...
	public function initialize() {
		...
		if ( ! function_exists( 'is_plugin_active' ) || ! \is_plugin_active( 'advanced-custom-fields-pro/acf.php' ) ) {
			return;
		}
	...
	public function add_color_choices( $field ) {
		...
		if ( isset( $field['choices'] ) ) {
			...
			} elseif ( rwp_str_has( $field['name'], 'bs_border_' ) ) {
				$colors = rwp_collection( rwp_bootstrap_colors( 'border-' ) );
			} elseif ( rwp_str_has( $field['name'], 'bs_text_' ) ) {
				$colors = rwp_collection( rwp_bootstrap_colors( 'text-' ) );
			} elseif ( rwp_str_has( $field['name'], 'bs_btn_style' ) ) {

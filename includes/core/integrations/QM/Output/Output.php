...
use RWP\Html\Table;
use RWP\Html\TableSection;
use RWP\Html\TableRow;
use RWP\Html\TableCell;

abstract class Output extends \QM_Output_Html {
	...
	public function __construct( \QM_Collector $collector, \RWP\Integrations\QM\QM $parent, $id = '' ) {
	...
	public static function table_row( $vars ) {
		...
		if ( is_array( $vars ) && ! empty( $vars ) ) {
			foreach ( $vars as $key => $var ) {
				...
				} elseif ( rwp_str_is_html( $var ) && ! rwp_str_has( $var, 'qm-edit-link' ) ) {

 ...
 */
namespace RWP\Vendor\Composer;

use RWP\Vendor\Composer\Autoload\ClassLoader;
use RWP\Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
     ...
     * @return bool
     */
    public static function satisfies(\RWP\Vendor\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        ...
        if (self::$canGetVendors) {
            foreach (\RWP\Vendor\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {

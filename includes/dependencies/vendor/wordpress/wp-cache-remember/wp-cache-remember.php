 ...
 */
if (!\function_exists('RWP\\Vendor\\wp_cache_remember')) {
    /**
...
if (!\function_exists('RWP\\Vendor\\wp_cache_forget')) {
    /**
...
if (!\function_exists('RWP\\Vendor\\remember_transient')) {
    /**
...
if (!\function_exists('RWP\\Vendor\\forget_transient')) {
    /**
...
if (!\function_exists('RWP\\Vendor\\remember_site_transient')) {
    /**
...
if (!\function_exists('RWP\\Vendor\\forget_site_transient')) {
    /**

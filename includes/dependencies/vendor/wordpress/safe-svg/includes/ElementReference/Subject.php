...
namespace RWP\Vendor\SafeSVG\ElementReference;

use RWP\Vendor\SafeSVG\Exceptions\NestingException;
...
class Subject {
	...
	public function hasInfiniteLoop(array $subjects = [], $level = 1) {
		if ($level > $this->useNestingLimit) {
			throw new NestingException('Nesting level too high, aborting', 1570713498, null, $this->getElement());
		}

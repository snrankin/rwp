...
if (!\function_exists('RWP\\Vendor\\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    function WPDeskInitWpNoticeAjaxHandler($assetsUrl = null) {
        $ajax_handler = new AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('RWP\\Vendor\\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('RWP\\Vendor\\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    function WPDeskWpNotice($noticeContent, $noticeType = 'info', $dismissible = \false, $priority = 10) {
        return Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('RWP\\Vendor\\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('RWP\\Vendor\\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    function WPDeskWpNoticeInfo($noticeContent, $dismissible = \false, $priority = 10) {
        return Factory::notice($noticeContent, Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('RWP\\Vendor\\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('RWP\\Vendor\\WPDeskWpNoticeError')) {
    /**
    ...
    function WPDeskWpNoticeError($noticeContent, $dismissible = \false, $priority = 10) {
        return Factory::notice($noticeContent, Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('RWP\\Vendor\\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('RWP\\Vendor\\WPDeskWpNoticeWarning')) {
    /**
    ...
    function WPDeskWpNoticeWarning($noticeContent, $dismissible = \false, $priority = 10) {
        return Factory::notice($noticeContent, Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('RWP\\Vendor\\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('RWP\\Vendor\\WPDeskWpNoticeSuccess')) {
    /**
    ...
    function WPDeskWpNoticeSuccess($noticeContent, $dismissible = \false, $priority = 10) {
        return Factory::notice($noticeContent, Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('RWP\\Vendor\\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('RWP\\Vendor\\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    function WPDeskPermanentDismissibleWpNotice($noticeContent, $noticeName, $noticeType = 'info', $priority = 10) {
        return Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('RWP\\Vendor\\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *

...
if (!\interface_exists('RWP\\Vendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('RWP\\Vendor\\WPDesk_Has_Plugin_Info')) {
 ...
 * have to be compatible with PHP 5.2.x
 */
\class_alias(__NAMESPACE__ . '\\WPDesk_Plugin_Info', 'WPDesk_Plugin_Info', \false);

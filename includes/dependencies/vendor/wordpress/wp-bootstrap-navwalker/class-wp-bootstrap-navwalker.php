...
/** ============================================================================
 * A custom WordPress nav walker class to implement the Bootstrap 4 navigation
 * style in a custom theme using the WordPress built in menu manager.
 *
 * @package wp-bootstrap-navwalker\/class-wp-bootstrap-navwalker.php
 * @version 4.3.0
...
if (class_exists('Walker_Nav_Menu')) {
	...
	class Bootstrap_Navwalker extends \Walker_Nav_Menu {
		...
		public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
			...
			if (\in_array('current-menu-item', $classes, \true) || \in_array('current-menu-parent', $classes, \true)) {
				$classes[] = 'active';
			}
			 ...
			 */
			if (\in_array('sr-only', $linkmod_classes, \true)) {
				$title = $this->wrap_for_screen_reader($title);
				$keys_to_unset = \array_keys($linkmod_classes, 'sr-only', \true);

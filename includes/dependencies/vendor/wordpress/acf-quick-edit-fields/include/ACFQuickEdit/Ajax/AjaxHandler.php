 ...
 *	2018-09-22
 */
namespace RWP\Vendor\ACFQuickEdit\Ajax;
...
class AjaxHandler
{
    ...
    {
        $this->_action = $action;
        $defaults = ['public' => \false, 'use_nonce' => \true, 'capability' => 'manage_options', 'callback' => null, 'sanitize_callback' => null];

...
class RangeField extends \RWP\Vendor\ACFQuickEdit\Fields\NumberField
{
    /**
     *	@inheritdoc
     */
    ...
    protected function render_input($input_atts, $is_quickedit = \true)
    {
        ...
        $output .= '<input ' . acf_esc_attr(['type' => 'number', 'id' => $this->acf_field['key'] . '-alt', 'data-acf-field-key' => $this->acf_field['key'], 'step' => $this->acf_field['step'], 'style' => \sprintf('min-width: %1$sem;max-width:%1$sem', 1.8 + $len * 0.7)]) . ' />';

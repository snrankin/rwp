...
class DateTimePickerField extends \RWP\Vendor\ACFQuickEdit\Fields\Field
{
    /**
     *	@inheritdoc
     */
    ...
    public function render_input($input_atts, $is_quickedit = \true)
    {
        ...
        $wrap_atts = ['class' => 'acf-quick-edit acf-quick-edit-' . $this->acf_field['type'], 'data-date_format' => acf_convert_date_to_js($formats['date']), 'data-time_format' => acf_convert_time_to_js($formats['time']), 'data-first_day' => $this->acf_field['first_day']];
        $display_input_atts = ['type' => 'text'];

...
class NumberField extends \RWP\Vendor\ACFQuickEdit\Fields\Field
{
    /**
     *	@inheritdoc
     */
    ...
    {
        $input_atts += ['class' => 'acf-quick-edit', 'type' => 'number', 'min' => $this->acf_field['min'], 'max' => $this->acf_field['max'], 'step' => $this->acf_field['step']];

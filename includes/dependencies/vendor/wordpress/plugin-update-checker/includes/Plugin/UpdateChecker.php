...
namespace RWP\Vendor\Puc\Plugin;
...
use RWP\Vendor\Puc\UpdateChecker as BaseUpdateChecker;
use RWP\Vendor\Puc\Scheduler;
use RWP\Vendor\Puc\DebugBar\PluginExtension;
...
class UpdateChecker extends BaseUpdateChecker {
	...
	public function requestInfo($queryArgs = array()) {
		list($pluginInfo, $result) = $this->requestMetadata('Plugin_Info', 'request_info', $queryArgs);
		if ($pluginInfo !== null) {
			/** @var Info $pluginInfo */

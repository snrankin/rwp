...
namespace RWP\Vendor\Micropackage\Requirements;

use RWP\Vendor\Micropackage\Internationalization\Internationalization;
use RWP\Vendor\Micropackage\Requirements\Interfaces\Checkable;
use RWP\Vendor\Micropackage\Requirements\Checker;
...
class Requirements {
     ...
     *                                  Default: true.
     */
    public function __construct($plugin_name, $requirements = [], $autoload_checkers = \true) {
    ...
    public function load_default_checkers() {
        \array_map([$this, 'register_checker'], [
			Checker\DocHooks::class, Checker\PHP::class, Checker\PHPExtensions::class, Checker\Plugins::class, Checker\Theme::class, Checker\WP::class]);
    }
    /**

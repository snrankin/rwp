...
namespace RWP\Vendor\Carbon\Traits;

use RWP\Vendor\Carbon\CarbonInterface;
use RWP\Vendor\Carbon\Exceptions\InvalidTypeException;
use RWP\Vendor\Carbon\Exceptions\NotLocaleAwareException;
use RWP\Vendor\Carbon\Language;
use RWP\Vendor\Carbon\Translator;
use Closure;
use RWP\Vendor\Symfony\Component\Translation\TranslatorBagInterface;
use RWP\Vendor\Symfony\Component\Translation\TranslatorInterface;
use RWP\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use RWP\Vendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

if (!\interface_exists('RWP\\Vendor\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    \class_alias(__NAMESPACE__ . '\\Symfony\\Contracts\\Translation\\TranslatorInterface', 'RWP\\Vendor\\Symfony\\Component\\Translation\\TranslatorInterface');
}
trait Localization {
    /**
     * Default translator.
    ...
    public static function translateWith(TranslatorInterface $translator, string $key, array $parameters = [], $number = null): string {
        ...
        $choice = $translator instanceof TranslatorInterface ? $translator->trans($key, $parameters) : $translator->transChoice($key, $number, $parameters);

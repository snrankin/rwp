...
class PluginState {
    ...
    public function loadSettings() {
        ...
        $config = \array_merge(array('include' => array(), 'require' => array(), 'recurse' => \true, 'replace' => \false, 'ignore-duplicates' => \false, 'merge-dev' => \true, 'merge-extra' => \false, 'merge-extra-deep' => \false, 'merge-scripts' => \false), isset($extra['merge-plugin']) ? $extra['merge-plugin'] : array());

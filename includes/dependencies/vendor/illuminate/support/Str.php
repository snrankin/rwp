...
use RWP\Vendor\League\CommonMark\GithubFlavoredMarkdownConverter;
use RWP\Vendor\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
use RWP\Vendor\Ramsey\Uuid\Generator\CombGenerator;
use RWP\Vendor\Ramsey\Uuid\Uuid;
use RWP\Vendor\Ramsey\Uuid\UuidFactory;
use RWP\Vendor\voku\helper\ASCII;
class Str
{
    use Macroable;
    /**

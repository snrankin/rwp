...
use Closure;
use Exception;
use RWP\Vendor\Illuminate\Contracts\Container\BindingResolutionException;
use RWP\Vendor\Illuminate\Contracts\Container\CircularDependencyException;
use RWP\Vendor\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;

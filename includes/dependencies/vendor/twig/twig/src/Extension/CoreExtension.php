...
use RWP\Vendor\Twig\ExpressionParser;
use RWP\Vendor\Twig\Node\Expression\Binary\AddBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\AndBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\BitwiseAndBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\BitwiseOrBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\BitwiseXorBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\ConcatBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\DivBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\EndsWithBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\EqualBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\FloorDivBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\GreaterBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\GreaterEqualBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\InBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\LessBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\LessEqualBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\MatchesBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\ModBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\MulBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\NotEqualBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\NotInBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\OrBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\PowerBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\RangeBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\SpaceshipBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\StartsWithBinary;
use RWP\Vendor\Twig\Node\Expression\Binary\SubBinary;
use RWP\Vendor\Twig\Node\Expression\Filter\DefaultFilter;
use RWP\Vendor\Twig\Node\Expression\NullCoalesceExpression;
use RWP\Vendor\Twig\Node\Expression\Test\ConstantTest;
use RWP\Vendor\Twig\Node\Expression\Test\DefinedTest;
use RWP\Vendor\Twig\Node\Expression\Test\DivisiblebyTest;
use RWP\Vendor\Twig\Node\Expression\Test\EvenTest;
use RWP\Vendor\Twig\Node\Expression\Test\NullTest;
use RWP\Vendor\Twig\Node\Expression\Test\OddTest;
use RWP\Vendor\Twig\Node\Expression\Test\SameasTest;
use RWP\Vendor\Twig\Node\Expression\Unary\NegUnary;
use RWP\Vendor\Twig\Node\Expression\Unary\NotUnary;
use RWP\Vendor\Twig\Node\Expression\Unary\PosUnary;
use RWP\Vendor\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use RWP\Vendor\Twig\TokenParser\ApplyTokenParser;
use RWP\Vendor\Twig\TokenParser\BlockTokenParser;
use RWP\Vendor\Twig\TokenParser\DeprecatedTokenParser;
use RWP\Vendor\Twig\TokenParser\DoTokenParser;
use RWP\Vendor\Twig\TokenParser\EmbedTokenParser;
use RWP\Vendor\Twig\TokenParser\ExtendsTokenParser;
use RWP\Vendor\Twig\TokenParser\FlushTokenParser;
use RWP\Vendor\Twig\TokenParser\ForTokenParser;
use RWP\Vendor\Twig\TokenParser\FromTokenParser;
use RWP\Vendor\Twig\TokenParser\IfTokenParser;
use RWP\Vendor\Twig\TokenParser\ImportTokenParser;
use RWP\Vendor\Twig\TokenParser\IncludeTokenParser;
use RWP\Vendor\Twig\TokenParser\MacroTokenParser;
use RWP\Vendor\Twig\TokenParser\SetTokenParser;
use RWP\Vendor\Twig\TokenParser\UseTokenParser;
use RWP\Vendor\Twig\TokenParser\WithTokenParser;
...
use RWP\Vendor\Twig\Error\LoaderError;
use RWP\Vendor\Twig\Error\RuntimeError;
use RWP\Vendor\Twig\Extension\CoreExtension;
use RWP\Vendor\Twig\Extension\SandboxExtension;
use RWP\Vendor\Twig\Markup;
use RWP\Vendor\Twig\Source;
use RWP\Vendor\Twig\Template;
use RWP\Vendor\Twig\TemplateWrapper;
/**
 * Cycles over a value.
 *
...
function twig_array_filter(Environment $env, $array, $arrow)
{
    ...
    if (!$arrow instanceof \Closure && $env->hasExtension('RWP\\Vendor\\Twig\\Extension\\SandboxExtension') && $env->getExtension('RWP\\Vendor\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {

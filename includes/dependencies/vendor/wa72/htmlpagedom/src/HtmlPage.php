...
use RWP\Vendor\Symfony\Component\CssSelector\CssSelector;
use RWP\Vendor\Wa72\HtmlPrettymin\PrettyMin;
/**
...
class HtmlPage
{
    ...
    {
        $this->dom = $this->dom->cloneNode(\true);
        $this->crawler = new HtmlPageCrawler($this->dom);
    }
    /**
    ...
    {
        if (!\class_exists('RWP\\Vendor\\Wa72\\HtmlPrettymin\\PrettyMin')) {

 ...
 */
namespace RWP\Vendor\Symfony\Bundle\DebugBundle;

use RWP\Vendor\Symfony\Bundle\DebugBundle\DependencyInjection\Compiler\DumpDataCollectorPass;
use RWP\Vendor\Symfony\Component\Console\Application;
use RWP\Vendor\Symfony\Component\DependencyInjection\ContainerBuilder;
use RWP\Vendor\Symfony\Component\HttpKernel\Bundle\Bundle;
...
class DebugBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new Bundle\DebugBundle\DependencyInjection\Compiler\DumpDataCollectorPass());
    }

...
namespace RWP\Vendor\Symfony\Component\EventDispatcher\DependencyInjection;

use RWP\Vendor\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
...
use RWP\Vendor\Symfony\Component\EventDispatcher\EventDispatcher;
use RWP\Vendor\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use RWP\Vendor\Symfony\Contracts\EventDispatcher\Event;
...
class RegisterListenersPass implements CompilerPassInterface {
    ...
    private function getEventFromTypeDeclaration(ContainerBuilder $container, string $id, string $method): string {
        if (null === ($class = $container->getDefinition($id)->getClass()) || !($r = $container->getReflectionClass($class, \false)) || !$r->hasMethod($method) || 1 > ($m = $r->getMethod($method))->getNumberOfParameters() || !($type = $m->getParameters()[0]->getType()) instanceof \ReflectionNamedType || $type->isBuiltin() || Contracts\EventDispatcher\Event::class === ($name = $type->getName())) {

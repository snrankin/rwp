...
use RWP\Vendor\Symfony\Component\Workflow\Registry;
use RWP\Vendor\Symfony\Component\Workflow\Transition;
use RWP\Vendor\Symfony\Component\Workflow\TransitionBlockerList;
 ...
 */
final class WorkflowExtension extends Extension\AbstractExtension {
    ...
    public function getEnabledTransition(object $subject, string $transition, string $name = null): ?Component\Workflow\Transition {

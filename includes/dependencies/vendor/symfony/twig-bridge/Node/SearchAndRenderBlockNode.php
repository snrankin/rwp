 ...
 */
final class SearchAndRenderBlockNode extends Node\Expression\FunctionExpression {
        ...
        if (isset($arguments[0])) {
            ...
            if (isset($arguments[1])) {
                if ('label' === $blockNameSuffix) {
                    ...
                    if ($label instanceof Node\Expression\ConstantExpression) {
                        ...
                        if (!twig_test_empty($label->getAttribute('value'))) {
                            ...
                            $variables = new Node\Expression\ArrayExpression([], $lineno);
                            $labelKey = new Node\Expression\ConstantExpression('label', $lineno);

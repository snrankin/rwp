...
use RWP\Vendor\Symfony\Component\Mime\Header\Headers;
use RWP\Vendor\Symfony\Component\Mime\Part\AbstractPart;
use RWP\Vendor\Twig\Extra\CssInliner\CssInlinerExtension;
use RWP\Vendor\Twig\Extra\Inky\InkyExtension;
use RWP\Vendor\Twig\Extra\Markdown\MarkdownExtension;

/**
 * @author Fabien Potencier <fabien@symfony.com>
 */
class NotificationEmail extends Bridge\Twig\Mime\TemplatedEmail {
    public const IMPORTANCE_URGENT = 'urgent';
    public const IMPORTANCE_HIGH = 'high';
    public const IMPORTANCE_MEDIUM = 'medium';
    public const IMPORTANCE_LOW = 'low';
    private $theme = 'default';
    private $context = ['importance' => self::IMPORTANCE_LOW, 'content' => '', 'exception' => \false, 'action_text' => null, 'action_url' => null, 'markdown' => \false, 'raw' => \false, 'footer_text' => 'Notification e-mail sent by Symfony'];
    public function __construct(Headers $headers = null, AbstractPart $body = null) {
        $missingPackages = [];
        if (!\class_exists(Extra\CssInliner\CssInlinerExtension::class)) {
            $missingPackages['twig/cssinliner-extra'] = ' CSS Inliner';
        }
        if (!\class_exists(Extra\Inky\InkyExtension::class)) {
    ...
    public function markdown(string $content) {
        if (!\class_exists(Extra\Markdown\MarkdownExtension::class)) {

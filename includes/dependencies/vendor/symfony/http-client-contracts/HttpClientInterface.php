...
use RWP\Vendor\Symfony\Contracts\HttpClient\Test\HttpClientTestCase;
...
interface HttpClientInterface {
     ...
     */
    public function request(string $method, string $url, array $options = []): Contracts\HttpClient\ResponseInterface;
    /**
     ...
     */
    public function stream($responses, float $timeout = null): Contracts\HttpClient\ResponseStreamInterface;
}

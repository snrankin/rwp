...
if (!\function_exists('mb_decode_mimeheader')) {
    ...
    {
        return Mbstring::mb_decode_mimeheader($string);
    }
}
if (!\function_exists('mb_encode_mimeheader')) {
    function mb_encode_mimeheader($string, $charset = null, $transfer_encoding = null, $newline = "\r\n", $indent = 0)
    {
        return Mbstring::mb_encode_mimeheader($string, $charset, $transfer_encoding, $newline, $indent);
    }
}
...
if (!\function_exists('mb_output_handler')) {
    ...
    {
        return Mbstring::mb_output_handler($string, $status);
    }
}
...
if (!\function_exists('mb_convert_variables')) {
    ...
    {
        return Mbstring::mb_convert_variables($to_encoding, $from_encoding, ...$vars);
    }
}

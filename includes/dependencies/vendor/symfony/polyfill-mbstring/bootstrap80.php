...
if (!\function_exists('mb_convert_encoding')) {
    ...
    {
        return Mbstring::mb_convert_encoding($string ?? '', (string) $to_encoding, $from_encoding);
    }
}
if (!\function_exists('mb_decode_mimeheader')) {
    function mb_decode_mimeheader(?string $string) : string
    {
        return Mbstring::mb_decode_mimeheader((string) $string);
    }
}
if (!\function_exists('mb_encode_mimeheader')) {
    function mb_encode_mimeheader(?string $string, ?string $charset = null, ?string $transfer_encoding = null, ?string $newline = "\r\n", ?int $indent = 0) : string
    {
        return Mbstring::mb_encode_mimeheader((string) $string, $charset, $transfer_encoding, (string) $newline, (int) $indent);
    }
}
if (!\function_exists('mb_decode_numericentity')) {
    function mb_decode_numericentity(?string $string, array $map, ?string $encoding = null) : string
    {
        return Mbstring::mb_decode_numericentity((string) $string, $map, $encoding);
    }
}
if (!\function_exists('mb_encode_numericentity')) {
    function mb_encode_numericentity(?string $string, array $map, ?string $encoding = null, ?bool $hex = \false) : string
    {
        return Mbstring::mb_encode_numericentity((string) $string, $map, $encoding, (bool) $hex);
    }
}
if (!\function_exists('mb_convert_case')) {
    function mb_convert_case(?string $string, ?int $mode, ?string $encoding = null) : string
    {
        return Mbstring::mb_convert_case((string) $string, (int) $mode, $encoding);
    }
}
...
if (!\function_exists('mb_encoding_aliases')) {
    ...
    {
        return Mbstring::mb_encoding_aliases((string) $encoding);
    }
}
...
if (!\function_exists('mb_detect_encoding')) {
    ...
    {
        return Mbstring::mb_detect_encoding((string) $string, $encodings, (bool) $strict);
    }
}
...
if (!\function_exists('mb_strlen')) {
    ...
    {
        return Mbstring::mb_strlen((string) $string, $encoding);
    }
}
if (!\function_exists('mb_strpos')) {
    function mb_strpos(?string $haystack, ?string $needle, ?int $offset = 0, ?string $encoding = null) : int|false
    {
        return Mbstring::mb_strpos((string) $haystack, (string) $needle, (int) $offset, $encoding);
    }
}
if (!\function_exists('mb_strtolower')) {
    function mb_strtolower(?string $string, ?string $encoding = null) : string
    {
        return Mbstring::mb_strtolower((string) $string, $encoding);
    }
}
if (!\function_exists('mb_strtoupper')) {
    function mb_strtoupper(?string $string, ?string $encoding = null) : string
    {
        return Mbstring::mb_strtoupper((string) $string, $encoding);
    }
}
...
if (!\function_exists('mb_convert_variables')) {
    ...
    {
        return Mbstring::mb_convert_variables((string) $to_encoding, $from_encoding ?? '', $var, ...$vars);
    }
}
if (!\function_exists('mb_ord')) {
    function mb_ord(?string $string, ?string $encoding = null) : int|false
    {
        return Mbstring::mb_ord((string) $string, $encoding);
    }
}
if (!\function_exists('mb_chr')) {
    function mb_chr(?int $codepoint, ?string $encoding = null) : string|false
    {
        return Mbstring::mb_chr((int) $codepoint, $encoding);
    }
}
...
if (!\function_exists('mb_str_split')) {
    ...
    {
        return Mbstring::mb_str_split((string) $string, (int) $length, $encoding);
    }
}

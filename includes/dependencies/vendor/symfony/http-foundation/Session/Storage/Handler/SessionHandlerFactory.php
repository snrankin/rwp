...
use RWP\Vendor\Doctrine\DBAL\DriverManager;
use RWP\Vendor\Symfony\Component\Cache\Adapter\AbstractAdapter;
    ...
    public static function createHandler($connection): AbstractSessionHandler {
        ...
        switch (\true) {
            ...
            case \str_starts_with($connection, 'pdo_oci://'):
                if (!\class_exists(DBAL\DriverManager::class)) {
                    throw new \InvalidArgumentException(\sprintf('Unsupported DSN "%s". Try running "composer require doctrine/dbal".', $connection));
                }
                $connection = DBAL\DriverManager::getConnection(['url' => $connection])->getWrappedConnection();
                // no break;

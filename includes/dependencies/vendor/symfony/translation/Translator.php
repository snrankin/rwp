...
use RWP\Vendor\Symfony\Component\Config\ConfigCacheFactory;
use RWP\Vendor\Symfony\Component\Config\ConfigCacheFactoryInterface;
use RWP\Vendor\Symfony\Component\Config\ConfigCacheInterface;
...
use RWP\Vendor\Symfony\Component\Translation\Formatter\IntlFormatterInterface;
use RWP\Vendor\Symfony\Component\Translation\Formatter\MessageFormatter;
use RWP\Vendor\Symfony\Component\Translation\Formatter\MessageFormatterInterface;
 ...
 */
class Translator implements Contracts\Translation\TranslatorInterface, TranslatorBagInterface, Contracts\Translation\LocaleAwareInterface {
    /**
...
EOF,
            $locale,
            \var_export($this->getAllMessages($this->catalogues[$locale]), \true),
            $fallbackContent
        );
...
EOF,
                $fallbackSuffix,
                $fallback,
                \var_export($this->getAllMessages($fallbackCatalogue), \true),
                $currentSuffix,
                $fallbackSuffix
            );

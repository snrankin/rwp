...
use RWP\Vendor\Symfony\Component\HttpFoundation\Cookie;
use RWP\Vendor\Symfony\Component\HttpFoundation\ParameterBag;
...
class RequestDataCollector extends DataCollector implements EventSubscriberInterface, LateDataCollectorInterface {
    ...
    public static function getSubscribedEvents() {
        return [Component\HttpKernel\KernelEvents::CONTROLLER => 'onKernelController', KernelEvents::RESPONSE => 'onKernelResponse'];
    }
    /**
     * {@inheritdoc}
     */

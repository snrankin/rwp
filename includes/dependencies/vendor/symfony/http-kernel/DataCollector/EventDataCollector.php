...
use RWP\Vendor\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher;
...
class EventDataCollector extends DataCollector implements LateDataCollectorInterface {
    ...
    public function __construct(Contracts\EventDispatcher\EventDispatcherInterface $dispatcher = null, RequestStack $requestStack = null) {
    ...
    public function reset() {
        $this->data = [];
        if ($this->dispatcher instanceof Contracts\Service\ResetInterface) {

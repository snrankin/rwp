...
namespace RWP\Vendor\Symfony\Component\HttpKernel;

use RWP\Vendor\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use RWP\Vendor\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use RWP\Vendor\Symfony\Component\Config\Builder\ConfigBuilderGenerator;
use RWP\Vendor\Symfony\Component\Config\ConfigCache;
use RWP\Vendor\Symfony\Component\Config\Loader\DelegatingLoader;
use RWP\Vendor\Symfony\Component\Config\Loader\LoaderResolver;
use RWP\Vendor\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use RWP\Vendor\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use RWP\Vendor\Symfony\Component\DependencyInjection\ContainerBuilder;
use RWP\Vendor\Symfony\Component\DependencyInjection\ContainerInterface;
use RWP\Vendor\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
use RWP\Vendor\Symfony\Component\DependencyInjection\Dumper\Preloader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use RWP\Vendor\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use RWP\Vendor\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
use RWP\Vendor\Symfony\Component\ErrorHandler\DebugClassLoader;
use RWP\Vendor\Symfony\Component\Filesystem\Filesystem;
use RWP\Vendor\Symfony\Component\HttpFoundation\Request;
use RWP\Vendor\Symfony\Component\HttpFoundation\Response;
use RWP\Vendor\Symfony\Component\HttpKernel\Bundle\BundleInterface;
use RWP\Vendor\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use RWP\Vendor\Symfony\Component\HttpKernel\Config\FileLocator;
use RWP\Vendor\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use RWP\Vendor\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface {
        ...
        if ($collectDeprecations = $this->debug && !\defined('PHPUNIT_COMPOSER_INSTALL')) {
            ...
            $previousHandler = \set_error_handler(function ($type, $message, $file, $line) use (&$collectedLogs, &$previousHandler) {
                ...
                for ($i = \count($backtrace) - 2; 0 < $i; --$i) {
                    if (\in_array($backtrace[$i]['class'] ?? null, [Component\ErrorHandler\DebugClassLoader::class, DebugClassLoader::class], \true)) {
    ...
    protected function getContainerBuilder() {
        ...
        if (\class_exists(Configuration::class) && \class_exists(Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator::class)) {
            $container->setProxyInstantiator(new Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator());
        }
        return $container;
    }
    /**
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass) {
        ...
        if (\class_exists(Configuration::class) && \class_exists(Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper::class)) {
            $dumper->setProxyDumper(new Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper());
        }

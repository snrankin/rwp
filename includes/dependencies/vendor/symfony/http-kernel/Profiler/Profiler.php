...
namespace RWP\Vendor\Symfony\Component\HttpKernel\Profiler;

use RWP\Vendor\Psr\Log\LoggerInterface;
use RWP\Vendor\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use RWP\Vendor\Symfony\Component\HttpFoundation\Request;
use RWP\Vendor\Symfony\Component\HttpFoundation\Response;
use RWP\Vendor\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface;
 ...
 */
class Profiler implements Contracts\Service\ResetInterface {
    private $storage;
    /**
    ...
    private $enabled = \true;
    public function __construct(ProfilerStorageInterface $storage, Log\LoggerInterface $logger = null, bool $enable = \true) {

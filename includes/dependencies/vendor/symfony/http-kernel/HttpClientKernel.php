...
use RWP\Vendor\Symfony\Component\HttpClient\HttpClient;
use RWP\Vendor\Symfony\Component\HttpFoundation\Request;
use RWP\Vendor\Symfony\Component\HttpFoundation\Response;
use RWP\Vendor\Symfony\Component\HttpFoundation\ResponseHeaderBag;
use RWP\Vendor\Symfony\Component\Mime\Part\AbstractPart;
use RWP\Vendor\Symfony\Component\Mime\Part\DataPart;
use RWP\Vendor\Symfony\Component\Mime\Part\Multipart\FormDataPart;
use RWP\Vendor\Symfony\Component\Mime\Part\TextPart;
use RWP\Vendor\Symfony\Contracts\HttpClient\HttpClientInterface;
...
final class HttpClientKernel implements HttpKernelInterface {
    private $client;
    public function __construct(Contracts\HttpClient\HttpClientInterface $client = null) {
    ...
    private function getBody(Request $request): ?Component\Mime\Part\AbstractPart {

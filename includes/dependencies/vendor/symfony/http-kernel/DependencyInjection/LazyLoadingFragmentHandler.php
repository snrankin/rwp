...
use RWP\Vendor\Symfony\Component\HttpKernel\Fragment\FragmentHandler;
...
class LazyLoadingFragmentHandler extends FragmentHandler {
    private $container;
    private $initialized = [];
    public function __construct(Container\ContainerInterface $container, RequestStack $requestStack, bool $debug = \false) {

...
use RWP\Vendor\Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use RWP\Vendor\Symfony\Component\DependencyInjection\Attribute\Target;
use RWP\Vendor\Symfony\Component\DependencyInjection\ChildDefinition;
...
use RWP\Vendor\Symfony\Component\DependencyInjection\ContainerAwareInterface;
...
use RWP\Vendor\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use RWP\Vendor\Symfony\Component\DependencyInjection\LazyProxy\ProxyHelper;
use RWP\Vendor\Symfony\Component\DependencyInjection\Reference;
use RWP\Vendor\Symfony\Component\DependencyInjection\TypedReference;
...
class RegisterControllerArgumentLocatorsPass implements CompilerPassInterface {
    ...
    public function process(ContainerBuilder $container) {
        ...
        foreach ($container->findTaggedServiceIds($this->controllerTag, \true) as $id => $tags) {
            ...
            $isContainerAware = $r->implementsInterface(ContainerAwareInterface::class) || \is_subclass_of($class, Bundle\FrameworkBundle\Controller\AbstractController::class);

...
namespace RWP\Vendor\Symfony\Component\HttpKernel\HttpCache;

use RWP\Vendor\Symfony\Component\HttpFoundation\IpUtils;
...
class SubRequestHandler {
    public static function handle(HttpKernelInterface $kernel, Request $request, int $type, bool $catch): Response {
        ...
        if (!Component\HttpFoundation\IpUtils::checkIp($remoteAddr, $trustedProxies)) {
        ...
        if (!Component\HttpFoundation\IpUtils::checkIp('127.0.0.1', $trustedProxies)) {

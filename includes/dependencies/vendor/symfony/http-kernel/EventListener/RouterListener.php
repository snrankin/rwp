...
use RWP\Vendor\Symfony\Component\HttpKernel\Exception\MethodNotAllowedHttpException;
use RWP\Vendor\Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use RWP\Vendor\Symfony\Component\HttpKernel\Kernel;
use RWP\Vendor\Symfony\Component\HttpKernel\KernelEvents;
use RWP\Vendor\Symfony\Component\Routing\Exception\MethodNotAllowedException;
use RWP\Vendor\Symfony\Component\Routing\Exception\NoConfigurationException;
use RWP\Vendor\Symfony\Component\Routing\Exception\ResourceNotFoundException;
use RWP\Vendor\Symfony\Component\Routing\Matcher\RequestMatcherInterface;
use RWP\Vendor\Symfony\Component\Routing\Matcher\UrlMatcherInterface;
use RWP\Vendor\Symfony\Component\Routing\RequestContext;
...
class RouterListener implements EventSubscriberInterface {
     ...
     */
    public function __construct($matcher, RequestStack $requestStack, RequestContext $context = null, Log\LoggerInterface $logger = null, string $projectDir = null, bool $debug = \true) {
    ...
    public static function getSubscribedEvents(): array {
        return [Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 32]], KernelEvents::FINISH_REQUEST => [['onKernelFinishRequest', 0]], KernelEvents::EXCEPTION => ['onKernelException', -64]];
    }

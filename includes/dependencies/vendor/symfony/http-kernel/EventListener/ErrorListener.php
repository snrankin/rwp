...
use RWP\Vendor\Symfony\Component\Debug\Exception\FlattenException as LegacyFlattenException;
...
use RWP\Vendor\Symfony\Component\HttpKernel\HttpKernelInterface;
use RWP\Vendor\Symfony\Component\HttpKernel\KernelEvents;
use RWP\Vendor\Symfony\Component\HttpKernel\Log\DebugLoggerInterface;
...
class ErrorListener implements EventSubscriberInterface {
    ...
    protected $logger;
    protected $debug;
    public function __construct($controller, Log\LoggerInterface $logger = null, bool $debug = \false) {
    ...
    public function onControllerArguments(ControllerArgumentsEvent $event) {
        ...
        if ($r && (!($r = $r->getType()) instanceof \ReflectionNamedType || \in_array($r->getName(), [Component\ErrorHandler\Exception\FlattenException::class, FlattenException::class], \true))) {
    ...
    public static function getSubscribedEvents(): array {
        return [Component\HttpKernel\KernelEvents::CONTROLLER_ARGUMENTS => 'onControllerArguments', KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]], KernelEvents::RESPONSE => ['removeCspHeader', -128]];
    }
    /**
     * Logs an exception.
     */

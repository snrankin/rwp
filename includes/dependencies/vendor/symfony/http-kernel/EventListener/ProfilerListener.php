...
use RWP\Vendor\Symfony\Component\HttpFoundation\RequestMatcherInterface;
...
use RWP\Vendor\Symfony\Component\HttpKernel\Profiler\Profiler;
...
class ProfilerListener implements EventSubscriberInterface {
    ...
    public static function getSubscribedEvents(): array {
        return [Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -100], KernelEvents::EXCEPTION => ['onKernelException', 0], KernelEvents::TERMINATE => ['onKernelTerminate', -1024]];
    }
}

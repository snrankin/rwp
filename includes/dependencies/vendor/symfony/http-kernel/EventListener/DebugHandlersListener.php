...
use RWP\Vendor\Symfony\Component\Console\Event\ConsoleEvent;
use RWP\Vendor\Symfony\Component\Console\Output\ConsoleOutputInterface;
use RWP\Vendor\Symfony\Component\ErrorHandler\ErrorHandler;
...
class DebugHandlersListener implements EventSubscriberInterface {
     ...
     */
    public function __construct(callable $exceptionHandler = null, Log\LoggerInterface $logger = null, $levels = \E_ALL, ?int $throwAt = \E_ALL, bool $scream = \true, $fileLinkFormat = null, bool $scope = \true, Log\LoggerInterface $deprecationLogger = null) {
    ...
    public static function getSubscribedEvents(): array {
        $events = [Component\HttpKernel\KernelEvents::REQUEST => ['configure', 2048]];
        if (\defined('Symfony\\Component\\Console\\ConsoleEvents::COMMAND')) {
            $events[Component\Console\ConsoleEvents::COMMAND] = ['configure', 2048];
        }
        return $events;
    }
}

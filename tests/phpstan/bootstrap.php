...
define( 'RWP_PLUGIN_FILE', dirname( __DIR__, 2 ) . '/rwp.php' );
define( 'RWP_PLUGIN_ROOT', plugin_dir_path( RWP_PLUGIN_FILE ) );
define( 'RWP_PLUGIN_URI', plugin_dir_url( RWP_PLUGIN_FILE ) );

...
if (!\class_exists( __NAMESPACE__  .  '\\PucReadmeParser', \false)) {
    /**
    ...
    class PucReadmeParser
    {
        ...
        {
            // whitelisted chars
            if (\function_exists('RWP\\Vendor\\user_sanitize')) {
                // bbPress native
        ...
        function filter_text($text, $markdown = \false)
        {
            ...
            if ($markdown) {
                // Parse markdown.
                if (!\class_exists( __NAMESPACE__  .  '\\Parsedown', \false)) {
        ...
        {
            if (\function_exists('RWP\\Vendor\\encodeit')) {
                // bbPress native
        ...
        {
            if (\function_exists('RWP\\Vendor\\decodeit')) {
                // bbPress native

...
class UpdateChecker extends BaseUpdateChecker {
	...
	public function requestUpdate() {
		list($themeUpdate, $result) = $this->requestMetadata('Theme_Update', 'request_update');
		if ($themeUpdate !== null) {
			/** @var Theme_Update $themeUpdate */
	...
	protected function createDebugBarExtension() {
		return new Extension($this, 'DebugBar_ThemePanel');
	}
	/**

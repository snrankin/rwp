...
namespace RWP\Vendor\PUC\VCS;

use RWP\Vendor\PUC\Utils;
use RWP\Vendor\PUC\OAuthSignature;
...
class BitBucketApi extends Api {
	...
	public function getBranch($branchName) {
		...
		return new Reference(array('name' => $branch->name, 'updated' => $branch->target->date, 'downloadUrl' => $this->getDownloadUrl($branch->name)));
	}
	/**
	 * Get a specific tag.
	 *

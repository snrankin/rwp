...
use \RWP\Vendor\PUC\v4p11\{InstalledPackage, Factory, Update as BaseUpdate};
 ...
 class Update extends BaseUpdate
    {
         ...
         *
         * @param StdClass|Info|Update $object The source object.
         * @return Update The new copy.
         */

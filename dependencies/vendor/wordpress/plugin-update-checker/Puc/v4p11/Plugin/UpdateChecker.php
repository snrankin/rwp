...
namespace RWP\Vendor\PUC\v4p11\Plugin;
use \RWP\Vendor\PUC\v4p11\{InstalledPackage, Scheduler, UpdateChecker as BaseUpdateChecker};

use \RWP\Vendor\PUC\v4p11\DebugBar\Extension;
    /**
    ...
    class UpdateChecker extends BaseUpdateChecker
    {
        ...
        {
            list($pluginInfo, $result) = $this->requestMetadata('Info', 'request_info', $queryArgs);
            if ($pluginInfo !== null) {
                /** @var Info $pluginInfo */
         ...
         *
         * @return Update|null An instance of Plugin_Update, or NULL when no updates are available.
         */

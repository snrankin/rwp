...
namespace RWP\Vendor\PUC\v4p11;
...
/**
    ...
    class Factory
    {
        ...
        protected static $myMajorVersion = '4';
        ...
        protected static function isPluginFile($absolutePath)
        {
            ...
            $pluginDir = self::normalizePath(strval(WP_PLUGIN_DIR));
            $muPluginDir = self::normalizePath(strval(WPMU_PLUGIN_DIR));

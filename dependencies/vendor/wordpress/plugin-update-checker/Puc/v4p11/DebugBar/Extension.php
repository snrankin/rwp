...
use \RWP\Vendor\PUC\v4p11\{InstalledPackage, Factory, Scheduler, UpdateChecker};
class Extension
{
	const RESPONSE_BODY_LENGTH_LIMIT = 4000;
	/** @var UpdateChecker */
	protected $updateChecker;
	protected $panelClass = 'Panel';
	...
	private function getLibraryUrl($filePath)
	{
		...
		$absolutePath = Factory::normalizePath($absolutePath);
		$pluginDir = Factory::normalizePath(\WP_PLUGIN_DIR);
		$muPluginDir = Factory::normalizePath(\WPMU_PLUGIN_DIR);
		$themeDir = Factory::normalizePath(get_theme_root());

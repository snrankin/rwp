(function() {
    var __webpack_modules__ = {
        "../node_modules/select2/dist/js/select2.full.js": function(module, exports, __webpack_require__) {
    ...
    !function() {
        ...
        Promise.resolve().then(__webpack_require__.t.bind(__webpack_require__, "../node_modules/select2/dist/js/select2.full.js", 23));
        jQuery(document).ready((function($) {
            ...
            if (select2Inputs.length > 0) {
                select2Inputs.forEach((function(input) {
                    ...
                    if (isSmall) {
                        select2Options.containerCssClass = "select2--small";
                        select2Options.selectionCssClass = "select2--small";
                        select2Options.dropdownCssClass = "select2--small";
                    }
                    if (isLarge) {
                        select2Options.containerCssClass = "select2--large";
                        select2Options.selectionCssClass = "select2--large";

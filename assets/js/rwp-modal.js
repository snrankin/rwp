...
_fancyapps_ui_src_Fancybox_Fancybox_js__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-fancybox]', {
  template: {
    // Close button icon
    closeButton: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16"><path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg>',
    // Loading indicator icon
    spinner: '<span class="rwp-spinner"><span></span><span></span><span></span><span></span></span>'
  },
  on: {
    reveal: function reveal(instance, slide) {
      var trigger = instance.options.$trigger;
      var theme = trigger.getAttribute('data-theme');
      var group = trigger.getAttribute('data-fancybox');
      var container = instance.$container;

      if (!(0,lodash__WEBPACK_IMPORTED_MODULE_1__.isNil)(group)) {
        container.classList.add("modal-group-".concat(group));
      }

      if (!(0,lodash__WEBPACK_IMPORTED_MODULE_1__.isNil)(theme)) {
        container.classList.add("modal-theme-".concat(theme));
      }
    }
  }
});

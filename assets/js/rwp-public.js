 ...
 * ==========================================================================
 */
var rwp = rwp || {}; // eslint-disable-line
...
var utils = {
  ...
  changeTag: function changeTag(original, tag) {
  ...
  toggleFocus: function toggleFocus() {
    if (event.type === 'focus' || event.type === 'blur') {
      ...
      if (!(0,lodash__WEBPACK_IMPORTED_MODULE_2__.isUndefined)(self)) {
        var elementClasses = self.classList;

        if (!(0,lodash__WEBPACK_IMPORTED_MODULE_2__.isNil)(elementClasses)) {
  ...
  screenSize: function screenSize(prop) {
    var size = {
    ...
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_2__.isNil)(prop)) {
      return size[prop];
    }
  ...
  toggleNav: function toggleNav(buttonId) {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        _link.addEventListener('touchstart', utils.toggleFocus, false);
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
  ...
  getTallest: function getTallest(el) {
  ...
  matchHeights: function matchHeights(el) {
    var matches = document.querySelectorAll(el);

    if (matches.length > 1) {
      var minHeight = rwp.utils.getTallest(el);
  ...
  logCustomProperties: function logCustomProperties() {
    ...
    var getCSSCustomPropIndex = function getCSSCustomPropIndex() {
      return (// styleSheets is array-like, so we convert it to an array.
        ...
        (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(document.styleSheets).filter(isSameDomain).reduce(function (finalArr, sheet) {
          return finalArr.concat( // cssRules is array-like, so we convert it to an array
          (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(sheet.cssRules).filter(isStyleRule).reduce(function (propValArr, rule) {
...
Object.assign(rwp, _util_utils__WEBPACK_IMPORTED_MODULE_0__.default);
window.rwp = {};

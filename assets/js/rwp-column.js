(function() {
    var __webpack_modules__ = {
        "./blocks/column/edit.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            ...
            var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@babel/runtime/helpers/esm/extends.js");
            ...
            var _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("../node_modules/@babel/runtime/helpers/esm/objectWithoutProperties.js");
            ...
            var _wordpress_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("@wordpress/components");
            var _wordpress_components__WEBPACK_IMPORTED_MODULE_5___default = __webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__);
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("@wordpress/compose");
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_6___default = __webpack_require__.n(_wordpress_compose__WEBPACK_IMPORTED_MODULE_6__);
            var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("@wordpress/block-editor");
            var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7___default = __webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__);
            var _wordpress_data__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("@wordpress/data");
            var _wordpress_data__WEBPACK_IMPORTED_MODULE_8___default = __webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__);
            var _global_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./blocks/global/icons.js");
            var _global_helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./blocks/global/helpers.js");
            var _edit_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./blocks/column/edit.scss");
            ...
            function compareColWidth(attributes) {
                var width = attributes.width, sizeXl = attributes.sizeXl;
                var colWidth = parseFloat(width) / 100;
                var closestCol = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.closest)(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.bsColumns);
                var colWidthClass = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.closest)(closestCol, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.bsColumns);
                colWidthClass = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.arraySearch)(_global_helpers__WEBPACK_IMPORTED_MODULE_10__.bsColumns, colWidthClass);
                if (colWidthClass == sizeXl) {
                    return true;
                }
                return false;
            }
            function getColWidth(attributes) {
                var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "class";
                var width = attributes.width, sizeXl = attributes.sizeXl;
                var colWidth;
                if (type === "class") {
                    colWidth = parseFloat(width) / 100;
                    colWidth = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.closest)(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.bsColumns);
                    colWidth = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.arraySearch)(_global_helpers__WEBPACK_IMPORTED_MODULE_10__.bsColumns, colWidth);
                    colWidth = colWidth - 1;
                } else {
                    colWidth = _global_helpers__WEBPACK_IMPORTED_MODULE_10__.bsColumns[sizeXl];
                    colWidth = colWidth * 100;
                    colWidth = "".concat(colWidth, "%");
                }
                return colWidth;
            }
            function colWidths(attributes) {
                var sizeXl = attributes.sizeXl, sizeLg = attributes.sizeLg, sizeMl = attributes.sizeMl, sizeMd = attributes.sizeMd, sizeMs = attributes.sizeMs, sizeSm = attributes.sizeSm, autoXl = attributes.autoXl, autoLg = attributes.autoLg, autoMl = attributes.autoMl, autoMd = attributes.autoMd, autoMs = attributes.autoMs, autoSm = attributes.autoSm, offsetXl = attributes.offsetXl, offsetLg = attributes.offsetLg, offsetMl = attributes.offsetMl, offsetMd = attributes.offsetMd, offsetMs = attributes.offsetMs, offsetSm = attributes.offsetSm, hAlign = attributes.hAlign, vAlign = attributes.vAlign, className = attributes.className, width = attributes.width;
                var classes = className;
                if (sizeSm > 0 & !autoSm) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-sm-".concat(sizeSm), classes, /col-sm-[\d|\w]+/);
                } else if (autoSm) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-sm-auto", classes, /col-sm-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /col-sm-[\d|\w]+/);
                }
                if (sizeMs > 0 & !autoMs) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-ms-".concat(sizeMs), classes, /col-ms-[\d|\w]+/);
                } else if (autoMs) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-ms-auto", classes, /col-ms-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /col-ms-[\d|\w]+/);
                }
                if (sizeMd > 0 & !autoMd) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-md-".concat(sizeMd), classes, /col-md-[\d|\w]+/);
                } else if (autoMd) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-md-auto", classes, /col-md-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /col-md-[\d|\w]+/);
                }
                if (sizeMl > 0 & !autoMl) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-ml-".concat(sizeMl), classes, /col-ml-[\d|\w]+/);
                } else if (autoMl) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-ml-auto", classes, /col-ml-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /col-ml-[\d|\w]+/);
                }
                if (sizeLg > 0 & !autoLg) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-lg-".concat(sizeLg), classes, /col-lg-[\d|\w]+/);
                } else if (autoLg) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-lg-auto", classes, /col-lg-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /col-lg-[\d|\w]+/);
                }
                if (sizeXl > 0 & !autoXl) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-xl-".concat(sizeXl), classes, /col-xl-[\d|\w]+/);
                } else if (autoXl) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("col-xl-auto", classes, /col-xl-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /col-xl-[\d|\w]+/);
                }
                if (offsetSm > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("offset-sm-".concat(offsetSm), classes, /offset-sm-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /offset-sm-[\d|\w]+/);
                }
                if (offsetMs > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("offset-ms-".concat(offsetMs), classes, /offset-ms-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /offset-ms-[\d|\w]+/);
                }
                if (offsetMd > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("offset-md-".concat(offsetMd), classes, /offset-md-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /offset-md-[\d|\w]+/);
                }
                if (offsetMl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("offset-ml-".concat(offsetMl), classes, /offset-ml-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /offset-ml-[\d|\w]+/);
                }
                if (offsetLg > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("offset-lg-".concat(offsetLg), classes, /offset-lg-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /offset-lg-[\d|\w]+/);
                }
                if (offsetXl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("offset-xl-".concat(offsetXl), classes, /offset-xl-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.updateClassesFromAtts)("", classes, /offset-xl-[\d|\w]+/);
                }
                classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.uniqueClasses)(classes);
                return classes;
            }
            var ColumnSizeRangeControl = function ColumnSizeRangeControl(_ref) {
                var label = _ref.label, attributeName = _ref.attributeName, value = _ref.value, setAttributes = _ref.setAttributes, props = (0, 
                _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2__["default"])(_ref, _excluded);
                return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.RangeControl, (0, 
                _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
                    label,
                    value,
                    onChange: function onChange(selectedSize) {
                        setAttributes((0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, attributeName, selectedSize));
                    },
                    min: 0,
                    max: 12
                }, props));
            };
            wp.hooks.addFilter("blocks.getBlockDefaultClassName", "rwp/column", (function(className, blockName) {
                if (blockName !== "rwp/column") {
                    return className;
                }
                className = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.classNames)("rwp", "col");
                return className;
            }));
            function Edit(props) {
                var _classNames;
                var attributes = props.attributes, setAttributes = props.setAttributes, clientId = props.clientId, isSelected = props.isSelected, hasInnerBlocks = props.hasInnerBlocks, name = props.name;
                var sizeXl = attributes.sizeXl, sizeLg = attributes.sizeLg, sizeMl = attributes.sizeMl, sizeMd = attributes.sizeMd, sizeMs = attributes.sizeMs, sizeSm = attributes.sizeSm, autoXl = attributes.autoXl, autoLg = attributes.autoLg, autoMl = attributes.autoMl, autoMd = attributes.autoMd, autoMs = attributes.autoMs, autoSm = attributes.autoSm, offsetXl = attributes.offsetXl, offsetLg = attributes.offsetLg, offsetMl = attributes.offsetMl, offsetMd = attributes.offsetMd, offsetMs = attributes.offsetMs, offsetSm = attributes.offsetSm, align = attributes.align, hAlign = attributes.hAlign, vAlign = attributes.vAlign, className = attributes.className, width = attributes.width, innerClasses = attributes.innerClasses;
                var _useDispatch = (0, _wordpress_data__WEBPACK_IMPORTED_MODULE_8__.useDispatch)("core/block-editor"), updateBlockAttributes = _useDispatch.updateBlockAttributes;
                var alignClass = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.selfAlignClass)(align);
                var colClasses = colWidths(attributes);
                var classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.classNames)(className, colClasses, alignClass);
                var blockProps = (0, _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.useBlockProps)({
                    className: classes
                });
                var contentClasses = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.classNames)("content-wrapper", (_classNames = {}, 
                (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_classNames, "".concat(attributes.innerClasses), (0, 
                _global_helpers__WEBPACK_IMPORTED_MODULE_10__.hasValue)(attributes.innerClasses)), 
                (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_classNames, "".concat(attributes.vAlign), (0, 
                _global_helpers__WEBPACK_IMPORTED_MODULE_10__.hasValue)(attributes.vAlign)), (0, 
                _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_classNames, "".concat(attributes.hAlign), (0, 
                _global_helpers__WEBPACK_IMPORTED_MODULE_10__.hasValue)(attributes.hAlign)), _classNames));
                var innerBlocksProps = (0, _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.__experimentalUseInnerBlocksProps)({
                    className: contentClasses
                }, {
                    renderAppender: hasInnerBlocks ? undefined : _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.InnerBlocks.ButtonBlockAppender
                });
                return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", blockProps, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.BlockControls, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.AlignmentToolbar, {
                    value: hAlign,
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Change horizontal alignment of content", "rwp"),
                    onChange: function onChange(val) {
                        return setAttributes({
                            hAlign: val
                        });
                    },
                    alignmentControls: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.alignControls)("content", "horizontal", "align-items")
                }), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.AlignmentToolbar, {
                    value: vAlign,
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Change vertical alignment of content", "rwp"),
                    onChange: function onChange(val) {
                        return setAttributes({
                            vAlign: val
                        });
                    },
                    alignmentControls: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_10__.alignControls)("content", "vertical")
                })), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.InspectorControls, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelBody, {
                    title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Screens > 1440px", "rwp"),
                    initialOpen: true,
                    icon: _global_icons__WEBPACK_IMPORTED_MODULE_9__.desktopIcon
                }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Column Width", "rwp"),
                    attributeName: "sizeXl",
                    value: sizeXl,
                    setAttributes,
                    disabled: autoXl
                }), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ToggleControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Auto Size", "rwp"),
                    checked: autoXl,
                ...
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Column offset", "rwp"),
                    attributeName: "offsetXl",
                    value: offsetXl,
                    setAttributes
                }))), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelBody, {
                    title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Screens > 1280px", "rwp"),
                    initialOpen: false,
                    icon: _global_icons__WEBPACK_IMPORTED_MODULE_9__.laptopIcon
                }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Column Width", "rwp"),
                ...
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    ...
                    title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Screens > 1024px", "rwp"),
                    initialOpen: false,
                    icon: _global_icons__WEBPACK_IMPORTED_MODULE_9__.tabletLandscapeIcon
                }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Column Width", "rwp"),
                ...
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    ...
                    title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Screens > 768px", "rwp"),
                    initialOpen: false,
                    icon: _global_icons__WEBPACK_IMPORTED_MODULE_9__.tabletPortraitIcon
                }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Column Width", "rwp"),
                ...
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    ...
                    title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Screens < 768px", "rwp"),
                    initialOpen: false,
                    icon: _global_icons__WEBPACK_IMPORTED_MODULE_9__.mobileIcon
                }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Column Width", "rwp"),
                ...
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnSizeRangeControl, {
                    ...
                    title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Extra Column Settings", "rwp"),
                    initialOpen: true
                }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.TextControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Inner Classes", "rwp"),
                    value: innerClasses,
                    onChange: function onChange(val) {
                        return setAttributes({
                            innerClasses: val
                ...
                })))), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", innerBlocksProps));
            }
            __webpack_exports__["default"] = (0, _wordpress_compose__WEBPACK_IMPORTED_MODULE_6__.compose)((0, 
            _wordpress_data__WEBPACK_IMPORTED_MODULE_8__.withSelect)((function(select, ownProps) {
                var clientId = ownProps.clientId, name = ownProps.name, setAttributes = ownProps.setAttributes;
                var _ref2 = select("core/block-editor") || select("core/editor"), getBlockOrder = _ref2.getBlockOrder;
        ...
        "./blocks/column/filters.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@babel/runtime/helpers/esm/extends.js");
            var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../node_modules/@babel/runtime/helpers/esm/defineProperty.js");
            var _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("../node_modules/@babel/runtime/helpers/esm/objectWithoutProperties.js");
            var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("@wordpress/i18n");
            var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3___default = __webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__);
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("@wordpress/compose");
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_4___default = __webpack_require__.n(_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__);
            ...
            var _wordpress_components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("@wordpress/components");
            var _wordpress_components__WEBPACK_IMPORTED_MODULE_6___default = __webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__);
            var _wordpress_element__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("@wordpress/element");
            var _wordpress_element__WEBPACK_IMPORTED_MODULE_7___default = __webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__);
            var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("@wordpress/block-editor");
            var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8___default = __webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__);
            var _wordpress_token_list__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("@wordpress/token-list");
            var _wordpress_token_list__WEBPACK_IMPORTED_MODULE_9___default = __webpack_require__.n(_wordpress_token_list__WEBPACK_IMPORTED_MODULE_9__);
            var _global_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./blocks/global/icons.js");
            var _global_helpers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./blocks/global/helpers.js");
            var _excluded = [ "label", "attributeName", "value", "setAttributes" ];
            ...
            function compareColWidth(attributes) {
                var width = attributes.width, sizeXl = attributes.sizeXl;
                var colWidth = parseFloat(width) / 100;
                var closestCol = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.closest)(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.bsColumns);
                var colWidthClass = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.closest)(closestCol, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.bsColumns);
                colWidthClass = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.arraySearch)(_global_helpers__WEBPACK_IMPORTED_MODULE_11__.bsColumns, colWidthClass);
                if (colWidthClass == sizeXl) {
                    return true;
                }
                return false;
            ...
            function getColWidth(attributes) {
                ...
                if (type === "class") {
                    colWidth = parseFloat(width) / 100;
                    colWidth = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.closest)(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.bsColumns);
                    colWidth = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.arraySearch)(_global_helpers__WEBPACK_IMPORTED_MODULE_11__.bsColumns, colWidth);
                    colWidth = colWidth - 1;
                } else {
                    colWidth = _global_helpers__WEBPACK_IMPORTED_MODULE_11__.bsColumns[sizeXl];
                    colWidth = colWidth * 100;
                    colWidth = "".concat(colWidth, "%");
                }
                return colWidth;
            }
            var colWidths = function colWidths(attributes) {
                var sizeXl = attributes.sizeXl, sizeLg = attributes.sizeLg, sizeMl = attributes.sizeMl, sizeMd = attributes.sizeMd, sizeMs = attributes.sizeMs, sizeSm = attributes.sizeSm, autoXl = attributes.autoXl, autoLg = attributes.autoLg, autoMl = attributes.autoMl, autoMd = attributes.autoMd, autoMs = attributes.autoMs, autoSm = attributes.autoSm, offsetXl = attributes.offsetXl, offsetLg = attributes.offsetLg, offsetMl = attributes.offsetMl, offsetMd = attributes.offsetMd, offsetMs = attributes.offsetMs, offsetSm = attributes.offsetSm, hAlign = attributes.hAlign, vAlign = attributes.vAlign, className = attributes.className, width = attributes.width;
                var classes = className;
                if (!autoSm && sizeSm > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-sm-".concat(sizeSm), classes, /col-sm-[\d|\w]+/);
                } else if (autoSm && sizeSm > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-sm-auto", classes, /col-sm-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /col-sm-[\d|\w]+/);
                }
                if (!autoMs && sizeMs > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-ms-".concat(sizeMs), classes, /col-ms-[\d|\w]+/);
                } else if (autoMs && sizeMs > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-ms-auto", classes, /col-ms-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /col-ms-[\d|\w]+/);
                }
                if (!autoMd && sizeMd > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-md-".concat(sizeMd), classes, /col-md-[\d|\w]+/);
                } else if (autoMd && sizeMd > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-md-auto", classes, /col-md-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /col-md-[\d|\w]+/);
                }
                if (!autoMl && sizeMl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-ml-".concat(sizeMl), classes, /col-ml-[\d|\w]+/);
                } else if (autoMl && sizeMl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-ml-auto", classes, /col-ml-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /col-ml-[\d|\w]+/);
                }
                if (!autoLg && sizeLg > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-lg-".concat(sizeLg), classes, /col-lg-[\d|\w]+/);
                } else if (autoLg && sizeLg > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-lg-auto", classes, /col-lg-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /col-lg-[\d|\w]+/);
                }
                if (!autoXl && sizeXl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-xl-".concat(sizeXl), classes, /col-xl-[\d|\w]+/);
                } else if (autoXl && sizeXl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("col-xl-auto", classes, /col-xl-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /col-xl-[\d|\w]+/);
                }
                if (offsetSm > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("offset-sm-".concat(offsetSm), classes, /offset-sm-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /offset-sm-[\d|\w]+/);
                }
                if (offsetMs > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("offset-ms-".concat(offsetMs), classes, /offset-ms-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /offset-ms-[\d|\w]+/);
                }
                if (offsetMd > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("offset-md-".concat(offsetMd), classes, /offset-md-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /offset-md-[\d|\w]+/);
                }
                if (offsetMl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("offset-ml-".concat(offsetMl), classes, /offset-ml-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /offset-ml-[\d|\w]+/);
                }
                if (offsetLg > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("offset-lg-".concat(offsetLg), classes, /offset-lg-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /offset-lg-[\d|\w]+/);
                }
                if (offsetXl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("offset-xl-".concat(offsetXl), classes, /offset-xl-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /offset-xl-[\d|\w]+/);
                }
                classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.uniqueClasses)(classes);
                return classes;
            };
            var ColumnSizeRangeControl = function ColumnSizeRangeControl(_ref) {
                var label = _ref.label, attributeName = _ref.attributeName, value = _ref.value, setAttributes = _ref.setAttributes, props = (0, 
                _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2__["default"])(_ref, _excluded);
                return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.RangeControl, (0, 
                _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
                    label,
                    value,
                    onChange: function onChange(selectedSize) {
                        if (attributeName === "sizeXl") {
                            if (selectedSize > 0) {
                                var _setAttributes;
                                var colWidth = _global_helpers__WEBPACK_IMPORTED_MODULE_11__.bsColumns[selectedSize];
                                colWidth = colWidth * 100;
                                setAttributes((_setAttributes = {}, (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_setAttributes, attributeName, selectedSize), 
                                (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_setAttributes, "width", colWidth), 
                                _setAttributes));
                            } else {
                                var _setAttributes2;
                                setAttributes((_setAttributes2 = {}, (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_setAttributes2, attributeName, selectedSize), 
                                (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_setAttributes2, "width", ""), 
                                _setAttributes2));
                            }
                        } else {
                            setAttributes((0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, attributeName, selectedSize));
            ...
            wp.hooks.addFilter("blocks.registerBlockType", "rwp/column", (function(props, name) {
                if ("core/column" !== name) {
                    return props;
                }
                var newAttributes = Object.assign(newAtts, props.attributes);
                return _objectSpread(_objectSpread({}, props), {}, {
                    newAttributes
                });
            }));
            wp.hooks.addFilter("blocks.getSaveElement", "core/column", (function(element, block, attributes) {
                if ("core/column" !== block.name) {
                    return element;
                }
                var elementChildren = (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)("div", {
                    className: "content-wrapper"
                }, element.props.children);
                element = (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.cloneElement)(element, null, elementChildren);
                return element;
            }));
            wp.hooks.addFilter("blocks.getBlockDefaultClassName", "rwp/column", (function(className, blockName) {
                return blockName === "core/column" ? "col" : className;
            }));
            wp.hooks.addFilter("editor.BlockListBlock", "rwp/column", (0, _wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.createHigherOrderComponent)((function(BlockListBlock) {
                return function(props) {
                    if (props.name !== "core/column") {
                        return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(BlockListBlock, props);
                    }
                    var attributes = props.attributes, setAttributes = props.setAttributes;
                    if (!compareColWidth(attributes)) {
                        var colWidth = getColWidth(attributes, "number");
                    ...
                    var width = attributes.width, sizeXl = attributes.sizeXl;
                    var classes = colWidths(attributes);
                    props.attributes.className = classes;
                    return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(BlockListBlock, props);
                };
            })));
            wp.hooks.addFilter("editor.BlockEdit", "rwp/column", (0, _wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.createHigherOrderComponent)((function(BlockEdit) {
                return function(props) {
                    if ("core/column" !== props.name) {
                        return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(BlockEdit, props);
                    }
                    var attributes = props.attributes, setAttributes = props.setAttributes;
                    var sizeXl = attributes.sizeXl, sizeLg = attributes.sizeLg, sizeMl = attributes.sizeMl, sizeMd = attributes.sizeMd, sizeMs = attributes.sizeMs, sizeSm = attributes.sizeSm, autoXl = attributes.autoXl, autoLg = attributes.autoLg, autoMl = attributes.autoMl, autoMd = attributes.autoMd, autoMs = attributes.autoMs, autoSm = attributes.autoSm, offsetXl = attributes.offsetXl, offsetLg = attributes.offsetLg, offsetMl = attributes.offsetMl, offsetMd = attributes.offsetMd, offsetMs = attributes.offsetMs, offsetSm = attributes.offsetSm, hAlign = attributes.hAlign, vAlign = attributes.vAlign, className = attributes.className, width = attributes.width;
                    var innerBlocksProps = (0, _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.__experimentalUseInnerBlocksProps)({
                        className: "content-wrapper"
                    });
                    return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__.Fragment, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(BlockEdit, props), (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.InspectorControls, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelBody, {
                        title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Screens > 1440px", "rwp"),
                        initialOpen: true,
                        icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__.desktopIcon
                    }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Column Width", "rwp"),
                        attributeName: "sizeXl",
                        value: sizeXl,
                        setAttributes
                    }), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToggleControl, {
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Auto Size", "rwp"),
                        checked: autoXl,
                        onChange: function onChange(isChecked) {
                            return setAttributes({
                                autoXl: isChecked,
                    ...
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Column offset", "rwp"),
                        attributeName: "offsetXl",
                        value: offsetXl,
                        setAttributes
                    }))), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelBody, {
                        title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Screens > 1280px", "rwp"),
                        initialOpen: false,
                        icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__.laptopIcon
                    }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Column Width", "rwp"),
                        attributeName: "sizeLg",
                    ...
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        ...
                        title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Screens > 1024px", "rwp"),
                        initialOpen: false,
                        icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__.tabletLandscapeIcon
                    }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Column Width", "rwp"),
                        attributeName: "sizeMl",
                    ...
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        ...
                        title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Screens > 768px", "rwp"),
                        initialOpen: false,
                        icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__.tabletPortraitIcon
                    }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Column Width", "rwp"),
                        attributeName: "sizeMd",
                    ...
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        ...
                        title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Screens < 768px", "rwp"),
                        initialOpen: false,
                        icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__.mobileIcon
                    }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_7__.createElement)(ColumnSizeRangeControl, {
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Column Width", "rwp"),
                        attributeName: "sizeSm",
        ...
        "./blocks/column/save.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            __webpack_require__.d(__webpack_exports__, {
                default: function() {
            ...
            var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("@wordpress/element");
            ...
            var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./blocks/column/edit.js");
            var _global_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./blocks/global/helpers.js");
            function Save(_ref) {
                var _classNames;
                var attributes = _ref.attributes;
                var alignClass = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_4__.selfAlignClass)(attributes.align);
                var colClasses = (0, _edit__WEBPACK_IMPORTED_MODULE_3__.colWidths)(attributes);
                var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save({
                    className: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_4__.classNames)(attributes.className, colClasses, alignClass)
                });
                var innerBlocksProps = {
                    className: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_4__.classNames)("content-wrapper", (_classNames = {}, 
                    (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_classNames, "".concat(attributes.innerClasses), (0, 
                    _global_helpers__WEBPACK_IMPORTED_MODULE_4__.hasValue)(attributes.innerClasses)), 
                    (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_classNames, "".concat(attributes.vAlign), (0, 
                    _global_helpers__WEBPACK_IMPORTED_MODULE_4__.hasValue)(attributes.vAlign)), (0, 
                    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_classNames, "".concat(attributes.hAlign), (0, 
                    _global_helpers__WEBPACK_IMPORTED_MODULE_4__.hasValue)(attributes.hAlign)), _classNames))
                };
                return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", blockProps, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", innerBlocksProps, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks.Content, null)));
            }
        },
        "./blocks/column/variations.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("@wordpress/i18n");
            var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__);
            var variations = [];
        ...
        "./blocks/column/edit.scss": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
        },
        ...
        "./blocks/column/block.json": function(module) {
            "use strict";
            module.exports = JSON.parse('{"apiVersion":2,"name":"rwp/column","title":"Column","category":"design","attributes":{"align":{"type":"string","default":""},"hAlign":{"type":"string","default":""},"vAlign":{"type":"string","default":""},"sizeSm":{"type":"number","default":0},"sizeMs":{"type":"number","default":0},"sizeMd":{"type":"number","default":0},"sizeMl":{"type":"number","default":0},"sizeLg":{"type":"number","default":0},"sizeXl":{"type":"number","default":0},"offsetSm":{"type":"number","default":0},"offsetMs":{"type":"number","default":0},"offsetMd":{"type":"number","default":0},"offsetMl":{"type":"number","default":0},"offsetLg":{"type":"number","default":0},"offsetXl":{"type":"number","default":0},"autoSm":{"type":"boolean","default":false},"autoMs":{"type":"boolean","default":false},"autoMd":{"type":"boolean","default":false},"autoMl":{"type":"boolean","default":false},"autoLg":{"type":"boolean","default":false},"autoXl":{"type":"boolean","default":false},"innerClasses":{"type":"string","default":""}},"supports":{"anchor":true,"align":true}}');
        }
    };
    ...
    !function() {
        ...
        var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./blocks/column/edit.js");
        var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./blocks/column/block.json");
        var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./blocks/column/save.js");
        var _variations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./blocks/column/variations.js");
        var _filters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./blocks/column/filters.js");
        ...
        var settings = Object.assign(_block_json__WEBPACK_IMPORTED_MODULE_3__, {
            icon: _global_icons__WEBPACK_IMPORTED_MODULE_1__.columnIcon,
...
//# sourceMappingURL=rwp-column.js.map
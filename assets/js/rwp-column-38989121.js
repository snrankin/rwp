...
/*!*******************************!*\
  !*** ./blocks/column/edit.js ***!
  \*******************************/
/*! exports provided: colWidths, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colWidths", function() { return colWidths; });
...
/* harmony import */ var _global_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../global/icons */ "./blocks/global/icons.js");
/* harmony import */ var _global_helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../global/helpers */ "./blocks/global/helpers.js");
/* harmony import */ var _edit_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./edit.scss */ "./blocks/column/edit.scss");
...
function compareColWidth(attributes) {
  ...
  var closestCol = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["closest"])(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_10__["bsColumns"]);
  var colWidthClass = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["closest"])(closestCol, _global_helpers__WEBPACK_IMPORTED_MODULE_10__["bsColumns"]);
  colWidthClass = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["arraySearch"])(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["bsColumns"], colWidthClass);
...
function getColWidth(attributes) {
  ...
  if (type === 'class') {
    ...
    colWidth = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["closest"])(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_10__["bsColumns"]);
    colWidth = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["arraySearch"])(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["bsColumns"], colWidth);
    colWidth = colWidth - 1;
  } else {
...
function colWidths(attributes) {
  var sizeXl = attributes.sizeXl,
      ...
      sizeMl = attributes.sizeMl,
      sizeMd = attributes.sizeMd,
      sizeMs = attributes.sizeMs,
      sizeSm = attributes.sizeSm,
      autoXl = attributes.autoXl,
      autoLg = attributes.autoLg,
      autoMl = attributes.autoMl,
      autoMd = attributes.autoMd,
      autoMs = attributes.autoMs,
      autoSm = attributes.autoSm,
      offsetXl = attributes.offsetXl,
      offsetLg = attributes.offsetLg,
      offsetMl = attributes.offsetMl,
      offsetMd = attributes.offsetMd,
      offsetMs = attributes.offsetMs,
  ...
  if (sizeSm > 0 & !autoSm) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("col-sm-".concat(sizeSm), classes, /col-sm-[\d|\w]+/);
  } else if (autoSm) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('col-sm-auto', classes, /col-sm-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /col-sm-[\d|\w]+/);
  }

  if (sizeMs > 0 & !autoMs) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("col-ms-".concat(sizeMs), classes, /col-ms-[\d|\w]+/);
  } else if (autoMs) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('col-ms-auto', classes, /col-ms-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /col-ms-[\d|\w]+/);
  }

  if (sizeMd > 0 & !autoMd) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("col-md-".concat(sizeMd), classes, /col-md-[\d|\w]+/);
  } else if (autoMd) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('col-md-auto', classes, /col-md-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /col-md-[\d|\w]+/);
  }

  if (sizeMl > 0 & !autoMl) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("col-ml-".concat(sizeMl), classes, /col-ml-[\d|\w]+/);
  } else if (autoMl) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('col-ml-auto', classes, /col-ml-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /col-ml-[\d|\w]+/);
  }

  if (sizeLg > 0 & !autoLg) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("col-lg-".concat(sizeLg), classes, /col-lg-[\d|\w]+/);
  } else if (autoLg) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('col-lg-auto', classes, /col-lg-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /col-lg-[\d|\w]+/);
  }

  if (sizeXl > 0 & !autoXl) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("col-xl-".concat(sizeXl), classes, /col-xl-[\d|\w]+/);
  } else if (autoXl) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('col-xl-auto', classes, /col-xl-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /col-xl-[\d|\w]+/);
  }

  if (offsetSm > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("offset-sm-".concat(offsetSm), classes, /offset-sm-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /offset-sm-[\d|\w]+/);
  }

  if (offsetMs > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("offset-ms-".concat(offsetMs), classes, /offset-ms-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /offset-ms-[\d|\w]+/);
  }

  if (offsetMd > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("offset-md-".concat(offsetMd), classes, /offset-md-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /offset-md-[\d|\w]+/);
  }

  if (offsetMl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("offset-ml-".concat(offsetMl), classes, /offset-ml-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /offset-ml-[\d|\w]+/);
  }

  if (offsetLg > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("offset-lg-".concat(offsetLg), classes, /offset-lg-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /offset-lg-[\d|\w]+/);
  }

  if (offsetXl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])("offset-xl-".concat(offsetXl), classes, /offset-xl-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["updateClassesFromAtts"])('', classes, /offset-xl-[\d|\w]+/);
  }

  classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["uniqueClasses"])(classes);
  return classes;
}
...
var ColumnSizeRangeControl = function ColumnSizeRangeControl(_ref) {
  var label = _ref.label,
      ...
      props = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2___default()(_ref, ["label", "attributeName", "value", "setAttributes"]);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["RangeControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    label: label,
    value: value,
    onChange: function onChange(selectedSize) {
      setAttributes(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, attributeName, selectedSize));
    },
    min: 0,
    max: 12
  }, props));
...
wp.hooks.addFilter('blocks.getBlockDefaultClassName', 'rwp/column', function (className, blockName) {
  ...
  className = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["classNames"])('rwp', 'col');
  return className;
});
...
function Edit(props) {
  ...
  var alignClass = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["selfAlignClass"])(align);
  var colClasses = colWidths(attributes);
  var classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["classNames"])(className, colClasses, alignClass);
  var blockProps = Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["useBlockProps"])({
    className: classes
  });
  var contentClasses = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["classNames"])('content-wrapper', (_classNames = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_classNames, "".concat(attributes.innerClasses), Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["hasValue"])(attributes.innerClasses)), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_classNames, "".concat(attributes.vAlign), Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["hasValue"])(attributes.vAlign)), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_classNames, "".concat(attributes.hAlign), Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["hasValue"])(attributes.hAlign)), _classNames));
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", blockProps, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["BlockControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["AlignmentToolbar"], {
    value: hAlign,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Change horizontal alignment of content', 'rwp'),
    onChange: function onChange(val) {
      return setAttributes({
        hAlign: val
      });
    },
    alignmentControls: Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["alignControls"])('content', 'horizontal', 'align-items')
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["AlignmentToolbar"], {
    value: vAlign,
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Change vertical alignment of content', 'rwp'),
    onChange: function onChange(val) {
      return setAttributes({
        vAlign: val
      });
    },
    alignmentControls: Object(_global_helpers__WEBPACK_IMPORTED_MODULE_10__["alignControls"])('content', 'vertical')
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelBody"], {
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Screens > 1440px', 'rwp'),
    initialOpen: true,
    icon: _global_icons__WEBPACK_IMPORTED_MODULE_9__["desktopIcon"]
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(ColumnSizeRangeControl, {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Column Width', 'rwp'),
    attributeName: "sizeXl",
    value: sizeXl,
    setAttributes: setAttributes,
    disabled: autoXl
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["ToggleControl"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Auto Size', 'rwp'),
    checked: autoXl,
  ...
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(ColumnSizeRangeControl, {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Column offset', 'rwp'),
    attributeName: "offsetXl",
    value: offsetXl,
    setAttributes: setAttributes
  }))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["PanelBody"], {
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Screens > 1280px', 'rwp'),
    initialOpen: false,
    ...
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Screens > 1024px', 'rwp'),
    initialOpen: false,
    ...
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Screens > 768px', 'rwp'),
    initialOpen: false,
    ...
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Extra Column Settings', 'rwp'),
    initialOpen: true
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Inner Classes', 'rwp'),
    value: innerClasses,
    onChange: function onChange(val) {
      return setAttributes({
        innerClasses: val
  ...
  })))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", innerBlocksProps));
}

/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_6__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["withSelect"])(function (select, ownProps) {
  ...
  var hasInnerBlocks = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["useSelect"])(function (select) {
...
/* harmony import */ var _wordpress_token_list__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @wordpress/token-list */ "@wordpress/token-list");
/* harmony import */ var _wordpress_token_list__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_wordpress_token_list__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _global_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../global/icons */ "./blocks/global/icons.js");
/* harmony import */ var _global_helpers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../global/helpers */ "./blocks/global/helpers.js");
...
function compareColWidth(attributes) {
  var width = attributes.width,
      sizeXl = attributes.sizeXl;
  var colWidth = parseFloat(width) / 100;
  var closestCol = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["closest"])(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_11__["bsColumns"]);
  var colWidthClass = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["closest"])(closestCol, _global_helpers__WEBPACK_IMPORTED_MODULE_11__["bsColumns"]);
  colWidthClass = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["arraySearch"])(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["bsColumns"], colWidthClass);
...
function getColWidth(attributes) {
  ...
  if (type === 'class') {
    colWidth = parseFloat(width) / 100;
    colWidth = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["closest"])(colWidth, _global_helpers__WEBPACK_IMPORTED_MODULE_11__["bsColumns"]);
    colWidth = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["arraySearch"])(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["bsColumns"], colWidth);
    colWidth = colWidth - 1;
  } else {
...
var colWidths = function colWidths(attributes) {
  ...
  if (!autoSm && sizeSm > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("col-sm-".concat(sizeSm), classes, /col-sm-[\d|\w]+/);
  } else if (autoSm && sizeSm > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('col-sm-auto', classes, /col-sm-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /col-sm-[\d|\w]+/);
  }

  if (!autoMs && sizeMs > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("col-ms-".concat(sizeMs), classes, /col-ms-[\d|\w]+/);
  } else if (autoMs && sizeMs > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('col-ms-auto', classes, /col-ms-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /col-ms-[\d|\w]+/);
  }

  if (!autoMd && sizeMd > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("col-md-".concat(sizeMd), classes, /col-md-[\d|\w]+/);
  } else if (autoMd && sizeMd > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('col-md-auto', classes, /col-md-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /col-md-[\d|\w]+/);
  }

  if (!autoMl && sizeMl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("col-ml-".concat(sizeMl), classes, /col-ml-[\d|\w]+/);
  } else if (autoMl && sizeMl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('col-ml-auto', classes, /col-ml-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /col-ml-[\d|\w]+/);
  }

  if (!autoLg && sizeLg > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("col-lg-".concat(sizeLg), classes, /col-lg-[\d|\w]+/);
  } else if (autoLg && sizeLg > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('col-lg-auto', classes, /col-lg-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /col-lg-[\d|\w]+/);
  }

  if (!autoXl && sizeXl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("col-xl-".concat(sizeXl), classes, /col-xl-[\d|\w]+/);
  } else if (autoXl && sizeXl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('col-xl-auto', classes, /col-xl-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /col-xl-[\d|\w]+/);
  }

  if (offsetSm > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("offset-sm-".concat(offsetSm), classes, /offset-sm-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /offset-sm-[\d|\w]+/);
  }

  if (offsetMs > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("offset-ms-".concat(offsetMs), classes, /offset-ms-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /offset-ms-[\d|\w]+/);
  }

  if (offsetMd > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("offset-md-".concat(offsetMd), classes, /offset-md-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /offset-md-[\d|\w]+/);
  }

  if (offsetMl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("offset-ml-".concat(offsetMl), classes, /offset-ml-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /offset-ml-[\d|\w]+/);
  }

  if (offsetLg > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("offset-lg-".concat(offsetLg), classes, /offset-lg-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /offset-lg-[\d|\w]+/);
  }

  if (offsetXl > 0) {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])("offset-xl-".concat(offsetXl), classes, /offset-xl-[\d|\w]+/);
  } else {
    classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["updateClassesFromAtts"])('', classes, /offset-xl-[\d|\w]+/);
  }

  classes = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_11__["uniqueClasses"])(classes);
  return classes;
};
...
var ColumnSizeRangeControl = function ColumnSizeRangeControl(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["RangeControl"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    label: label,
    value: value,
    onChange: function onChange(selectedSize) {
      if (attributeName === 'sizeXl') {
        if (selectedSize > 0) {
          ...
          colWidth = colWidth * 100;
          setAttributes((_setAttributes = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_setAttributes, attributeName, selectedSize), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_setAttributes, "width", colWidth), _setAttributes));
        } else {
          var _setAttributes2;

          setAttributes((_setAttributes2 = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_setAttributes2, attributeName, selectedSize), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_setAttributes2, "width", ''), _setAttributes2));
        }
      } else {
        setAttributes(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, attributeName, selectedSize));
      }
...
wp.hooks.addFilter('blocks.getSaveElement', 'core/column', function (element, block, attributes) {
  ...
  var elementChildren = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])('div', {
    className: 'content-wrapper'
  }, element.props.children);
  element = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["cloneElement"])(element, null, elementChildren);
  return element;
});
wp.hooks.addFilter('blocks.getBlockDefaultClassName', 'rwp/column', function (className, blockName) {
  return blockName === 'core/column' ? 'col' : className;
});
wp.hooks.addFilter('editor.BlockListBlock', 'rwp/column', Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__["createHigherOrderComponent"])(function (BlockListBlock) {
  return function (props) {
    if (props.name !== 'core/column') {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(BlockListBlock, props);
    }
...
wp.hooks.addFilter('editor.BlockEdit', 'rwp/column', Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__["createHigherOrderComponent"])(function (BlockEdit) {
  return function (props) {
    if ('core/column' !== props.name) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(BlockEdit, props);
    }
    ...
    var sizeXl = attributes.sizeXl,
        ...
        className = attributes.className,
        width = attributes.width;
    var innerBlocksProps = Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__["__experimentalUseInnerBlocksProps"])({
      className: 'content-wrapper'
    });
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(BlockEdit, props), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
      title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Screens > 1440px', 'rwp'),
      initialOpen: true,
      icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__["desktopIcon"]
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(ColumnSizeRangeControl, {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Column Width', 'rwp'),
      attributeName: "sizeXl",
      value: sizeXl,
      setAttributes: setAttributes
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["ToggleControl"], {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Auto Size', 'rwp'),
      checked: autoXl,
      onChange: function onChange(isChecked) {
        return setAttributes({
          autoXl: isChecked,
    ...
    })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(ColumnSizeRangeControl, {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Column offset', 'rwp'),
      attributeName: "offsetXl",
      value: offsetXl,
      setAttributes: setAttributes
    }))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
      title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Screens > 1280px', 'rwp'),
      initialOpen: false,
      ...
      title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Screens > 1024px', 'rwp'),
      initialOpen: false,
      ...
      title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Screens > 768px', 'rwp'),
      initialOpen: false,
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./blocks/column/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./blocks/column/block.json");
var _block_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./block.json */ "./blocks/column/block.json", 1);
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./blocks/column/save.js");
/* harmony import */ var _variations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./variations */ "./blocks/column/variations.js");
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filters */ "./blocks/column/filters.js");
/**
 * ============================================================================
 * BLOCK: rwp/column
 *
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./blocks/column/edit.js");
...
function Save(_ref) {
  ...
  var alignClass = Object(_global_helpers__WEBPACK_IMPORTED_MODULE_4__["selfAlignClass"])(attributes.align);
  var colClasses = Object(_edit__WEBPACK_IMPORTED_MODULE_3__["colWidths"])(attributes);
  var blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__["useBlockProps"].save({
    className: Object(_global_helpers__WEBPACK_IMPORTED_MODULE_4__["classNames"])(attributes.className, colClasses, alignClass)
  });
  var innerBlocksProps = {
    className: Object(_global_helpers__WEBPACK_IMPORTED_MODULE_4__["classNames"])('content-wrapper', (_classNames = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classNames, "".concat(attributes.innerClasses), Object(_global_helpers__WEBPACK_IMPORTED_MODULE_4__["hasValue"])(attributes.innerClasses)), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classNames, "".concat(attributes.vAlign), Object(_global_helpers__WEBPACK_IMPORTED_MODULE_4__["hasValue"])(attributes.vAlign)), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classNames, "".concat(attributes.hAlign), Object(_global_helpers__WEBPACK_IMPORTED_MODULE_4__["hasValue"])(attributes.hAlign)), _classNames))
  };
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", blockProps, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", innerBlocksProps, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__["InnerBlocks"].Content, null)));
}

/***/ }),

/***/ "./blocks/column/variations.js":
/*!*************************************!*\
  !*** ./blocks/column/variations.js ***!
  \*************************************/
/*! exports provided: default */
...
/***/ 1:
/*!**************************************!*\
  !*** multi ./blocks/column/index.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./blocks/column/index.js */"./blocks/column/index.js");
...
/******/ });
//# sourceMappingURL=rwp-column-38989121.js.map
(function() {
    var __webpack_modules__ = {
        ...
        "./blocks/row/core-variations.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("@wordpress/element");
            var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
            var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("@wordpress/components");
            var _wordpress_components__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__);
            var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("@wordpress/i18n");
            ...
            var variations = [ {
                ...
                title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Sidebar Left"),
                description: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Main column with sidebar on left"),
                icon: (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SVG, {
                    width: "48",
                    height: "48",
                    viewBox: "0 0 48 48",
                ...
                title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Sidebar Right"),
                description: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Main column with sidebar on right"),
                icon: (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SVG, {
                    width: "48",
                    height: "48",
                    viewBox: "0 0 48 48",
        ...
        "./blocks/row/edit.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            __webpack_require__.d(__webpack_exports__, {
                rowClasses: function() {
            ...
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("@wordpress/compose");
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_7___default = __webpack_require__.n(_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__);
            ...
            var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("@wordpress/blocks");
            var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_9___default = __webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_9__);
            var _wordpress_data__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("@wordpress/data");
            var _wordpress_data__WEBPACK_IMPORTED_MODULE_10___default = __webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__);
            var _global_icons__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./blocks/global/icons.js");
            var _global_helpers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./blocks/global/helpers.js");
            var _excluded = [ "label", "attributeName", "value", "setAttributes" ];
            function rowClasses(attributes) {
                var rowColsXl = attributes.rowColsXl, rowColsLg = attributes.rowColsLg, rowColsMl = attributes.rowColsMl, rowColsMd = attributes.rowColsMd, rowColsMs = attributes.rowColsMs, rowColsSm = attributes.rowColsSm, hAlign = attributes.hAlign, vAlign = attributes.vAlign, className = attributes.className, noGutters = attributes.noGutters;
                var classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.classNames)(className, {
                    "no-gutters": noGutters
                });
                if (rowColsSm > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("row-cols-sm-".concat(rowColsSm), classes, /row-cols-sm-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /row-cols-sm-[\d|\w]+/);
                }
                if (rowColsMs > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("row-cols-ms-".concat(rowColsMs), classes, /row-cols-ms-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /row-cols-ms-[\d|\w]+/);
                }
                if (rowColsMd > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("row-cols-md-".concat(rowColsMd), classes, /row-cols-md-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /row-cols-md-[\d|\w]+/);
                }
                if (rowColsMl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("row-cols-ml-".concat(rowColsMl), classes, /row-cols-ml-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /row-cols-ml-[\d|\w]+/);
                }
                if (rowColsLg > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("row-cols-lg-".concat(rowColsLg), classes, /row-cols-lg-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /row-cols-lg-[\d|\w]+/);
                }
                if (rowColsXl > 0) {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("row-cols-xl-".concat(rowColsXl), classes, /row-cols-xl-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /row-cols-xl-[\d|\w]+/);
                }
                if (!(0, lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(hAlign) && hAlign !== "none" && hAlign !== "") {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)(hAlign, classes, /justify-content-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /justify-content-[\d|\w]+/);
                }
                if (!(0, lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(vAlign) && vAlign !== "none" && vAlign !== "") {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)(vAlign, classes, /align-items-[\d|\w]+/);
                } else {
                    classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.updateClassesFromAtts)("", classes, /align-items-[\d|\w]+/);
                }
                classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.uniqueClasses)(classes);
                return classes;
            }
            var ColumnsRangeControl = function ColumnsRangeControl(_ref) {
                ...
                return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.RangeControl, (0, 
            ...
            var BLOCK_TEMPLATE = [ [ "rwp/column", {} ] ];
            var ALLOWED_BLOCKS = [ "rwp/column" ];
            var TEMPLATE_LOCK = false;
            wp.hooks.addFilter("blocks.getBlockDefaultClassName", "rwp/row", (function(className, blockName) {
                if (blockName !== "rwp/row") {
                    return className;
                }
                className = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.classNames)("rwp", "row");
                return className;
            }));
            function Edit(props) {
                ...
                var noGutters = attributes.noGutters, hAlign = attributes.hAlign, vAlign = attributes.vAlign, rowColsXl = attributes.rowColsXl, rowColsLg = attributes.rowColsLg, rowColsMl = attributes.rowColsMl, rowColsMd = attributes.rowColsMd, rowColsMs = attributes.rowColsMs;
                var classes = rowClasses(attributes);
                var blockProps = (0, _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.useBlockProps)({
                    className: classes
                });
                var innerBlocksProps = (0, _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.__experimentalUseInnerBlocksProps)(blockProps, {
                    templateLock: TEMPLATE_LOCK,
                    allowedBlocks: ALLOWED_BLOCKS,
                    orientation: "horizontal",
                    renderAppender: hasInnerBlocks ? undefined : _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.InnerBlocks.ButtonBlockAppender
                });
                var placeholder = (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", blockProps, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.__experimentalBlockVariationPicker, {
                    ...
                    onSelect: function onSelect() {
                        ...
                        if (nextVariation.innerBlocks) {
                            wp.data.dispatch("core/block-editor").replaceInnerBlocks(clientId, (0, _wordpress_blocks__WEBPACK_IMPORTED_MODULE_9__.createBlocksFromInnerBlocksTemplate)(nextVariation.innerBlocks), true);
                        }
                    },
                    allowSkip: true
                }));
                return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.Fragment, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.BlockControls, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.AlignmentToolbar, {
                    value: hAlign,
                    icon: _global_icons__WEBPACK_IMPORTED_MODULE_11__.hAlignStart,
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Change horizontal alignment of columns", "rwp"),
                    onChange: function onChange(val) {
                        return setAttributes({
                            hAlign: val
                        });
                    },
                    alignmentControls: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.alignControls)("columns", "horizontal")
                }), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.AlignmentToolbar, {
                    value: vAlign,
                    icon: _global_icons__WEBPACK_IMPORTED_MODULE_11__.vStretch,
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Change vertical alignment of columns", "rwp"),
                    onChange: function onChange(val) {
                        return setAttributes({
                            vAlign: val
                        });
                    },
                    alignmentControls: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_12__.alignControls)("columns", "vertical", "align-items")
                })), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.InspectorControls, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelBody, {
                    title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Row Settings", "rwp"),
                    initialOpen: true
                }, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToggleControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Remove Gutters", "rwp"),
                    checked: noGutters,
                ...
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnsRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Number of columns per row XL", "rwp"),
                    attributeName: "rowColsXl",
                    value: rowColsXl,
                    setAttributes
                })), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnsRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Number of columns per row LG", "rwp"),
                    attributeName: "rowColsLg",
                    value: rowColsLg,
                    setAttributes
                })), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnsRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Number of columns per row ML", "rwp"),
                    attributeName: "rowColsMl",
                    value: rowColsMl,
                    setAttributes
                })), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnsRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Number of columns per row MD", "rwp"),
                    attributeName: "rowColsMd",
                    value: rowColsMd,
                    setAttributes
                })), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelRow, null, (0, 
                _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnsRangeControl, {
                    label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Number of columns per row MS", "rwp"),
                    attributeName: "rowColsMs",
                    value: rowColsMs,
                    setAttributes
                })))), hasInnerBlocks ? (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", innerBlocksProps) : placeholder);
            }
            __webpack_exports__["default"] = (0, _wordpress_compose__WEBPACK_IMPORTED_MODULE_7__.compose)((0, 
            _wordpress_data__WEBPACK_IMPORTED_MODULE_10__.withSelect)((function(select, ownProps) {
                ...
                var hasInnerBlocks = (0, _wordpress_data__WEBPACK_IMPORTED_MODULE_10__.useSelect)((function(select) {
        ...
        "./blocks/row/filters.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@babel/runtime/helpers/esm/extends.js");
            var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../node_modules/@babel/runtime/helpers/esm/defineProperty.js");
            ...
            var _wordpress_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("@wordpress/data");
            var _wordpress_data__WEBPACK_IMPORTED_MODULE_6___default = __webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__);
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("@wordpress/compose");
            var _wordpress_compose__WEBPACK_IMPORTED_MODULE_7___default = __webpack_require__.n(_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__);
            var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("@wordpress/block-editor");
            var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8___default = __webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__);
            var _wordpress_editor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("@wordpress/editor");
            var _wordpress_editor__WEBPACK_IMPORTED_MODULE_9___default = __webpack_require__.n(_wordpress_editor__WEBPACK_IMPORTED_MODULE_9__);
            ...
            var _core_variations__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./blocks/row/core-variations.js");
            var _excluded = [ "label", "attributeName", "value", "setAttributes" ];
            ...
            var _ref = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__ || _wordpress_editor__WEBPACK_IMPORTED_MODULE_9__, InnerBlocks = _ref.InnerBlocks, InspectorControls = _ref.InspectorControls, BlockControls = _ref.BlockControls, AlignmentToolbar = _ref.AlignmentToolbar;
            var ColumnsRangeControl = function ColumnsRangeControl(_ref2) {
                var label = _ref2.label, attributeName = _ref2.attributeName, value = _ref2.value, setAttributes = _ref2.setAttributes, props = (0, 
                _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2__["default"])(_ref2, _excluded);
            ...
            wp.hooks.addFilter("editor.BlockListBlock", "rwp/row", (0, _wordpress_compose__WEBPACK_IMPORTED_MODULE_7__.createHigherOrderComponent)((function(BlockListBlock) {
                return function(props) {
                    if (props.name !== "core/columns") {
                        return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(BlockListBlock, props);
                    }
                    var attributes = props.attributes;
                    var rowColsXl = attributes.rowColsXl, rowColsLg = attributes.rowColsLg, rowColsMl = attributes.rowColsMl, rowColsMd = attributes.rowColsMd, rowColsMs = attributes.rowColsMs, rowColsSm = attributes.rowColsSm, hAlign = attributes.hAlign, vAlign = attributes.vAlign, className = attributes.className, noGutters = attributes.noGutters;
                    var classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.classNames)(className, {
                        "no-gutters": noGutters
                    });
                    if (rowColsSm > 0) {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("row-cols-sm-".concat(rowColsSm), classes, /row-cols-sm-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /row-cols-sm-[\d|\w]+/);
                    }
                    if (rowColsMs > 0) {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("row-cols-ms-".concat(rowColsMs), classes, /row-cols-ms-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /row-cols-ms-[\d|\w]+/);
                    }
                    if (rowColsMd > 0) {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("row-cols-md-".concat(rowColsMd), classes, /row-cols-md-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /row-cols-md-[\d|\w]+/);
                    }
                    if (rowColsMl > 0) {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("row-cols-ml-".concat(rowColsMl), classes, /row-cols-ml-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /row-cols-ml-[\d|\w]+/);
                    }
                    if (rowColsLg > 0) {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("row-cols-lg-".concat(rowColsLg), classes, /row-cols-lg-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /row-cols-lg-[\d|\w]+/);
                    }
                    if (rowColsXl > 0) {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("row-cols-xl-".concat(rowColsXl), classes, /row-cols-xl-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /row-cols-xl-[\d|\w]+/);
                    }
                    if (hAlign != undefined && hAlign !== "none") {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("justify-content-".concat(hAlign), classes, /justify-content-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /justify-content-[\d|\w]+/);
                    }
                    if (vAlign != undefined && vAlign !== "none") {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("align-items-".concat(vAlign), classes, /align-items-[\d|\w]+/);
                    } else {
                        classes = (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.updateClassesFromAtts)("", classes, /align-items-[\d|\w]+/);
                    }
            ...
            wp.hooks.addFilter("editor.BlockEdit", "rwp/row", (0, _wordpress_compose__WEBPACK_IMPORTED_MODULE_7__.createHigherOrderComponent)((function(BlockEdit) {
                return function(props) {
                    if ("core/columns" !== props.name) {
                        return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(BlockEdit, props);
                    }
                    var attributes = props.attributes, setAttributes = props.setAttributes;
                    var noGutters = attributes.noGutters, hAlign = attributes.hAlign, vAlign = attributes.vAlign, rowColsXl = attributes.rowColsXl, rowColsLg = attributes.rowColsLg, rowColsMl = attributes.rowColsMl, rowColsMd = attributes.rowColsMd, rowColsMs = attributes.rowColsMs, className = attributes.className;
                    return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.Fragment, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(BlockEdit, props), (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(InspectorControls, null, (0, 
                    ...
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ColumnsRangeControl, {
                        ...
                        value: rowColsMs,
                        setAttributes
                    })))), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(BlockControls, null, (0, 
                    _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(AlignmentToolbar, {
                        value: hAlign,
                        icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__.hAlignCenter,
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Change horizontal alignment of columns", "rwp"),
                        onChange: function onChange(val) {
                            return setAttributes({
                                hAlign: val
                        ...
                        alignmentControls: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.alignControls)("columns", "horizontal")
                    }), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(AlignmentToolbar, {
                        value: vAlign,
                        icon: _global_icons__WEBPACK_IMPORTED_MODULE_10__.vAlignCenter,
                        label: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Change vertical alignment of columns", "rwp"),
                        onChange: function onChange(val) {
                            return setAttributes({
                                vAlign: val
                        ...
                        alignmentControls: (0, _global_helpers__WEBPACK_IMPORTED_MODULE_11__.alignControls)("columns", "vertical")
                    })));
                };
            })));
            wp.hooks.addFilter("blocks.registerBlockType", "rwp/row", (function(props, name) {
                ...
                return _objectSpread(_objectSpread({}, props), {}, {
                    variations: _core_variations__WEBPACK_IMPORTED_MODULE_12__["default"],
                    attributes
                });
            }));
        },
        "./blocks/row/save.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            __webpack_require__.d(__webpack_exports__, {
                default: function() {
            ...
            var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./blocks/row/edit.js");
            function Save(_ref) {
                ...
                return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
                    className: (0, _edit__WEBPACK_IMPORTED_MODULE_3__.rowClasses)(attributes)
                }), (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InnerBlocks.Content, null));
            }
        },
        "./blocks/row/variations.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("@wordpress/element");
            var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
            ...
            var variations = [ {
                ...
                name: "two-columns-equal",
                title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("1/2 + 1/2"),
                description: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Two columns; equal split"),
                icon: (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SVG, {
                    width: "48",
                    height: "48",
                ...
                title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("1/3 + 2/3"),
                description: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Main column with sidebar on left"),
                icon: (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SVG, {
                    width: "48",
                    height: "48",
                ...
                title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("2/3 + 1/3"),
                description: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Main column with sidebar on right"),
                icon: (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SVG, {
                    width: "48",
                    height: "48",
                ...
                name: "three-columns-equal",
                title: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("1/3 + 1/3 + 1/3"),
                description: (0, _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Three columns; equal split"),
                icon: (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SVG, {
                    width: "48",
                    height: "48",
        ...
        "./blocks/row/block.json": function(module) {
            "use strict";
            module.exports = JSON.parse('{"apiVersion":2,"name":"rwp/row","title":"Row","category":"design","attributes":{"hAlign":{"type":"string","default":""},"vAlign":{"type":"string","default":""},"rowColsSm":{"type":"number","default":0},"rowColsMs":{"type":"number","default":0},"rowColsMd":{"type":"number","default":0},"rowColsMl":{"type":"number","default":0},"rowColsLg":{"type":"number","default":0},"rowColsXl":{"type":"number","default":0},"noGutters":{"type":"boolean","default":false}},"supports":{"anchor":true}}');
        }
    };
    ...
    !function() {
        ...
        var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./blocks/row/edit.js");
        var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./blocks/row/block.json");
        var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./blocks/row/save.js");
        var _variations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./blocks/row/variations.js");
        var _filters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./blocks/row/filters.js");
        ...
        var settings = Object.assign(_block_json__WEBPACK_IMPORTED_MODULE_3__, {
            icon: _global_icons__WEBPACK_IMPORTED_MODULE_1__.rowIcon,
...
//# sourceMappingURL=rwp-row.js.map
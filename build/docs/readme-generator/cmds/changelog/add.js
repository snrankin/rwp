...
const { ChangelogEntry, getChangelogOptions, logResult, execSync, isAttributionValid, isEntryValid, isLinkValid, getChangelogValidationIssues } = require('../../utils');
const opts = getChangelogOptions();
...
function generateList(option) {
	return Object.entries(opts[option]).map(([value, desc]) => ({
